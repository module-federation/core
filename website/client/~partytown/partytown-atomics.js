...
((e) => {
    ...
    M = (e, t, r, i, o, a, l, c) => {
      if (((a = {}), !r.has(t)))
        for (l in (r.add(t), t))
          s(l) &&
            ((c =
              'path' === l && n(t).endsWith('Event') ? t.composedPath() : t[l]),
            (i || 'function' != typeof c) &&
              (o || '' !== c) &&
              (a[l] = I(e, c, r)));
      return a;
  ...
  (async (e) => {
      ...
      if (0 === s) {
        const e = (() => {
          const e = S.createElement('i'),
            ...
            s = _($, 'IntersectionObserver'),
            o = _($, 'MutationObserver'),
            a = _($, 'ResizeObserver'),
            l = $.performance,
            c = $.screen,
            u = [
    ...
    e &&
      ...
      (J.onmessage = (t) => {
        const r = t.data;
        12 === r[0] ? U(J, r[1]) : e(J, r);
      }),
      $.addEventListener('pt1', (e) =>
        H(J, f(e.detail.frameElement), e.detail)
      ));
  });
})(window);
