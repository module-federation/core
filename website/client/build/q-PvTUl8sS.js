...
import { a as h, B as w } from './q-UhehzwuD.js';
import { C as v } from './q-XhXTUHYG.js';
import { S as _, a as S } from './q-T3cxTwNd.js';
import { l as k } from './q-JZLb1D8d.js';
import { a as C, u as e } from './q-Scd2ZB6o.js';
const P = '',
  E = P,
  T = async (n) => {
    const [a] = b();
  ...
  F = () => {
    x(
      i(() => m(() => Promise.resolve().then(() => p), void 0), 's_Z790sFa7bTY')
    );
    const n = d(!1),
      a = d(!1),
      s = C(),
      u = (r) => k(r, s),
      o = i(
        () => m(() => Promise.resolve().then(() => p), void 0),
        's_kK15dHxr40k',
        [n, a]
      ),
      f = e('contact.title@@Talk to our experts');
    return c(
      S,
      {
        class: 'scroll-mt-32',
        ...
        children: [
          c(
            _,
            { 'q:slot': 'header', title: f, [t]: { 'q:slot': t } },
            3,
            'Ia_0'
          ),
          l(
                ...
                [
                      ...
                      l(
                        ...
                        [
                          l(
                            ...
                            e('contact.form.name.label@@Your name'),
                            1,
                            null
                          ),
                          l(
                      ...
                      l(
                        ...
                        [
                          l(
                            ...
                            e('contact.form.company-size.label@@Company size'),
                            1,
                            null
                          ),
                          l(
                        ...
                        [
                          ...
                          c(
                            h,
                            {
                              ...
                              children: e('contact.form.action@@Submit'),
                              small: !0,
                              [t]: {
                                class: t,
                                loading: y((r) => r.value, [n]),
                                small: t,
                                theme: t,
                                type: t,
                              },
                  ...
                  l(
                    ...
                    [
                      ...
                      l(
                        'a',
                        { href: u('/privacy-policy') },
                        { class: 'text-ui-blue' },
                        e('contact.disclaimer.action@@Privacy & Policy'),
                        1,
                        null
                      ),
                      '.',
                  ...
                  l(
                    ...
                    [
                      l(
                        ...
                        null,
                        {
                          alt: e('contact.quote.author.name@@Zack Jackson'),
                          class: 'w-12 h-12',
                      ...
                      l(
                        ...
                        [
                          l(
                            ...
                            e('contact.quote.author.name@@Zack Jackson'),
                            1,
                            null
                          ),
                          l(
