import { f as l, e as c } from './q-9ngTyHsh.js';
const b = (e = {}) => {
  const [r, m, o, s] = l();
  let t, a;
  return (
    e instanceof SubmitEvent
      ...
      : (t = e),
    new Promise((n) => {
      t instanceof FormData && (s.formData = t),
        (s.isRunning = !0),
        (o.isNavigating = !0),
        (r.value = { data: t, id: m, resolve: c(n) });
    }).then(({ result: n, status: i }) => {
      if (((s.isRunning = !1), (s.status = i), (s.value = n), a)) {
        a.getAttribute('data-spa-reset') === 'true' && a.reset();
        const f = { status: i, value: n };
        a.dispatchEvent(
