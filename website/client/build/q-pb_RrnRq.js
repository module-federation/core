...
import { L as e } from './q-51TGVSGw.js';
...
const i = l(
  ...
  p = () => (
    s(
      a(() => r(() => Promise.resolve().then(() => _), void 0), 's_0kXSZC4QkmM')
    ),
    t(
      u,
      {
        children: [
          l(
            ...
            l(
              ...
              [
                o('discord.title@@Join to Module Federation community in'),
                ' ',
                l(
                  'a',
                  null,
  ...
  _ = Object.freeze(
    Object.defineProperty(
      { __proto__: null, s_0kXSZC4QkmM: g, s_KHl60H7GIzk: p },
      Symbol.toStringTag,
      { value: 'Module' }
    )
  );
export { g as s_0kXSZC4QkmM, p as s_KHl60H7GIzk };
