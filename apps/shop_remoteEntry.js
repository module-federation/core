...
/***/ "./node_modules/.federation/entry.70d23efe3b688ecbb29b44a06a1a5f2e.js":
/*!****************************************************************************!*\
  !*** ./node_modules/.federation/entry.70d23efe3b688ecbb29b44a06a1a5f2e.js ***!
  \****************************************************************************/
...
/* harmony import */ var _Users_bytedance_dev_universe_packages_webpack_bundler_runtime_dist_embedded_esm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../packages/webpack-bundler-runtime/dist/embedded.esm.js */ "../../packages/webpack-bundler-runtime/dist/embedded.esm.js");
...
const federationInstance = new _Users_bytedance_dev_universe_packages_webpack_bundler_runtime_dist_embedded_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"].runtime.FederationManager(
 false ? 0 : "shop:1.0.0"
);
Object.assign(__webpack_require__.federation.runtime, federationInstance.getMethods());
	...
	for(var key in _Users_bytedance_dev_universe_packages_webpack_bundler_runtime_dist_embedded_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"]){
		__webpack_require__.federation[key] = _Users_bytedance_dev_universe_packages_webpack_bundler_runtime_dist_embedded_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"][key];
	}
...
/* harmony export */   FederationManager: () => (/* binding */ FederationManager),
...
/* harmony export */ });
const { FederationHost, registerGlobalPlugins, getRemoteEntry, getRemoteInfo, loadScript, loadScriptNode, init, loadRemote, loadShare, loadShareSync, preloadRemote, registerRemotes, registerPlugins, getInstance, FederationManager } = __webpack_require__.federation.runtime;
...
function createScriptNode(url, cb, attrs, loaderHook) {
    ...
    const handleScriptFetch = async (f, urlObj)=>{
        try {
            ...
            // );
            //@ts-ignore
            const exportedInterface = require(path.join(dir, "../../../", filename));
...
/* harmony export */ });
/* harmony import */ var _module_federation_runtime_embedded__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @module-federation/runtime/embedded */ "../../packages/runtime/dist/embedded.esm.js");
/* harmony import */ var _initContainerEntry_esm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./initContainerEntry.esm.js */ "../../packages/webpack-bundler-runtime/dist/initContainerEntry.esm.js");
/* harmony import */ var _constant_esm_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constant.esm.js */ "../../packages/webpack-bundler-runtime/dist/constant.esm.js");
...
// debugger;
var federation = {
    runtime: _module_federation_runtime_embedded__WEBPACK_IMPORTED_MODULE_0__,
    instance: undefined,
    ...
    bundlerRuntime: {
        ...
        S: {},
        installInitialConsumes: _initContainerEntry_esm_js__WEBPACK_IMPORTED_MODULE_1__.a,
        initContainerEntry: _initContainerEntry_esm_js__WEBPACK_IMPORTED_MODULE_1__.b
    },
    attachShareScopeMap: _initContainerEntry_esm_js__WEBPACK_IMPORTED_MODULE_1__.d,
...
/* harmony export */ });
/* harmony import */ var _constant_esm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constant.esm.js */ "../../packages/webpack-bundler-runtime/dist/constant.esm.js");
    ...
    if (webpackRequire.o(chunkMapping, chunkId)) {
        chunkMapping[chunkId].forEach(function(id) {
            ...
            var onRemoteLoaded = function() {
                try {
                    var remoteName = (0,_module_federation_sdk__WEBPACK_IMPORTED_MODULE_1__.decodeName)(remoteInfos[0].name, _module_federation_sdk__WEBPACK_IMPORTED_MODULE_1__.ENCODE_NAME_PREFIX);
            ...
            var useRuntimeLoad = remoteInfos.length === 1 && _constant_esm_js__WEBPACK_IMPORTED_MODULE_0__.FEDERATION_SUPPORTED_TYPES.includes(remoteInfos[0].externalType) && remoteInfos[0].name;
            if (useRuntimeLoad) {
    ...
    if (bundlerRuntimeRemotesOptions) {
        Object.keys(bundlerRuntimeRemotesOptions.idToRemoteMap).forEach(function(moduleId) {
            ...
            if (info.length > 1) {
                ...
                if (!_constant_esm_js__WEBPACK_IMPORTED_MODULE_0__.FEDERATION_SUPPORTED_TYPES.includes(remoteInfo.externalType)) {
                    initExternal(externalModuleId);
                }
            }
        });
...
var moduleMap = {
	...
	"./pages/shop/exposed-pages": () => {
		return __webpack_require__.e(/*! __federation_expose_pages__shop__exposed_pages */ "__federation_expose_pages__shop__exposed_pages").then(() => (() => ((__webpack_require__(/*! ./pages/shop/exposed-pages.tsx */ "./pages/shop/exposed-pages.tsx")))));
	},
	"./pages/shop/index": () => {
		return __webpack_require__.e(/*! __federation_expose_pages__shop__index */ "__federation_expose_pages__shop__index").then(() => (() => ((__webpack_require__(/*! ./pages/shop/index.tsx */ "./pages/shop/index.tsx")))));
	},
	"./pages/shop/test-webpack-png": () => {
		return __webpack_require__.e(/*! __federation_expose_pages__shop__test_webpack_png */ "__federation_expose_pages__shop__test_webpack_png").then(() => (() => ((__webpack_require__(/*! ./pages/shop/test-webpack-png.tsx */ "./pages/shop/test-webpack-png.tsx")))));
	},
	"./pages/shop/test-webpack-svg": () => {
		return __webpack_require__.e(/*! __federation_expose_pages__shop__test_webpack_svg */ "__federation_expose_pages__shop__test_webpack_svg").then(() => (() => ((__webpack_require__(/*! ./pages/shop/test-webpack-svg.tsx */ "./pages/shop/test-webpack-svg.tsx")))));
	},
	"./pages/shop/products/[...slug]": () => {
		return __webpack_require__.e(/*! __federation_expose_pages__shop__products__[...slug] */ "__federation_expose_pages__shop__products__[...slug]").then(() => (() => ((__webpack_require__(/*! ./pages/shop/products/[...slug].tsx */ "./pages/shop/products/[...slug].tsx")))));
	}
};
...
/******/ 			__webpack_require__.federation = {
/******/ 				initOptions: {"name":"shop","remotes":[{"alias":"home","name":"home_app","entry":"http://localhost:3000/_next/static/ssr/remoteEntry.js","shareScope":"default"},{"alias":"checkout","name":"checkout","entry":"http://localhost:3002/_next/static/ssr/remoteEntry.js","shareScope":"default"}],"shareStrategy":"loaded-first"},
/******/ 				chunkMatcher: function(chunkId) {return !/^(webpack_sharing_consume_default_(ant\-design_colors_ant\-design_colors\-webpack_sharing_consume_d\-(1dea55[01]|249655[01]|83d466[01]|b8eb24[01])|react_jsx\-runtime_react_jsx\-runtime\-_1fa9[012345])|__federation_expose_next__router)$/.test(chunkId)},
/******/ 				rootOutputDir: "",
...
/******/ 				getter: () => (Promise.all([__webpack_require__.e("vendor-chunks/rc-util@5.43.0_react-dom@18.2.0_react@18.2.0"), __webpack_require__.e("vendor-chunks/@ant-design+icons@5.4.0_react-dom@18.2.0_react@18.2.0"), __webpack_require__.e("vendor-chunks/@babel+runtime@7.24.8"), __webpack_require__.e("webpack_sharing_consume_default_ant-design_colors_ant-design_colors-webpack_sharing_consume_d-83d4661")]).then(() => (() => (__webpack_require__(/*! @ant-design/icons/es/icons/EllipsisOutlined */ "../../node_modules/.pnpm/@ant-design+icons@5.4.0_react-dom@18.2.0_react@18.2.0/node_modules/@ant-design/icons/es/icons/EllipsisOutlined.js"))))),
/******/ 				shareInfo: {
/******/ 					shareConfig: {
/******/ 					  "fixedDependencies": false,
/******/ 					  "requiredVersion": "^5.3.7",
...
/******/ 					promises.push(installedChunkData[2]);
/******/ 				} else {
/******/ 					if(!/^(webpack_sharing_consume_default_(ant\-design_colors_ant\-design_colors\-webpack_sharing_consume_d\-(1dea55[01]|249655[01]|83d466[01]|b8eb24[01])|react_jsx\-runtime_react_jsx\-runtime\-_1fa9[012345])|__federation_expose_next__router)$/.test(chunkId)) {
...
/******/ 		__webpack_require__(/*! ../../node_modules/.pnpm/next@14.1.2_@babel+core@7.24.9_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/build/webpack/loaders/next-swc-loader.js??ruleSet[1].rules[6].oneOf[0].use[0]!./node_modules/.federation/entry.70d23efe3b688ecbb29b44a06a1a5f2e.js */ "./node_modules/.federation/entry.70d23efe3b688ecbb29b44a06a1a5f2e.js")
/******/ 	})();
/******/ 	
/************************************************************************/
/******/ 	
