...
In the consumer, we need to use the [createLazyComponent](/practice/bridge/react-bridge/load-component.html#什么是-createlazycomponent) API to load the remote component and fetch its data.
