...
export const moduleFederationPluginOverview: any = {
  name: 'module-federation-doc:overview',

  async setup(api) {
    const root = path.join(__dirname, '../docs/zh/configure/');
