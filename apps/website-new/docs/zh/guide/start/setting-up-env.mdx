...
在开始前，我们需要你具备以下前置条件，下文中遇到不熟的名词请查看[名词解释](/guide/start/glossary)：

- 你需要了解 Module Federation 的[基本概念和适用场景](/guide/start/index)
...
- 配置构建插件: 配置每个应用程序的 [Webpack](/guide/basic/webpack)、[Rspack](/guide/basic/rspack) 配置文件以使用 Module Federation。
- 使用共享模块: 根据需要在应用程序中使用共享模块。

有关更多信息和高级配置选项，请参考 [构建配置](/config/index) 文档。
