...
Module Federation 2.0 用于与 Webpack 中的 Module Federation (1.0) 进行区分。在 Module Federation 2.0 中，重新设计了运行时和构建工具之间的关系，并引入了Manifest文件。与 1.0 相比，Module Federation 2.0 引入了更多主要新功能。
