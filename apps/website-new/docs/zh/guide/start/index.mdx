...
- ⚡ 代码共享、依赖复用
- 📝 Manifest
- 🎨 [Module Federation 运行时](/guide/runtime/index.html)
- 🧩 [运行时插件系统](/plugin/dev/index.html)
- 🚀 [动态类型提示](/guide/basic/type-prompt.html)
- 🛠️ [Chrome Devtool](/guide/debug/chrome-devtool.html)
- 🦀 [Rspack](/integrations/bundler/rspack.html) and [Webpack](/integrations/bundler/webpack.html) Support
...
* [飞书交流群](https://applink.larkoffice.com/client/chat/chatter/add_by_link?link_token=4e8g1afc-aa1e-4931-a2fb-06b218a4a7d1)
