...
Module Federation 具有以下特性：

- 代码共享：可以在多个应用程序之间共享代码、样式和资源。
- 按需加载：仅在需要时加载代码，从而提高性能。
- 动态更新：可以动态更新应用程序中的代码，无需重新部署整个应用程序。
- 支持多种框架：支持 React、Vue、Angular 等多种框架。
- 支持多种构建工具：[Webpack](/guide/basic/webpack)、[Rspack](/guide/basic/rspack)、[Vite](https://github.com/originjs/vite-plugin-federation)。
...
- 提供 Devtool 工具
- 提供更多的上层框架能力 Router、SSR、Sandbox
...
<NextSteps>
  ...
  />
  <Step
    href="/guide/basic/configure-module-federation"
    title="查阅配置"
