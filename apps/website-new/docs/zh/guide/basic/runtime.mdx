...
init({
    ...
    remotes: [
        {
          name: "@vmok-e2e/module-doc-app1",
          alias: "remotes-app1",
          version: '*'
        },
        {
          name: "@vmok-e2e/edenx-demo-app2",
          alias: "remotes-app2",
          version: '*'
        }
    ],
...
// 模块加载
const RemoteTooltip = React.lazy(() => loadRemote('remotes-app1/myTooltip'));
const RemoteButton = React.lazy(() => loadRemote('remotes-app2/Button'));

export default () => {
  return (
    <div>
      <p>RemoteButton from app2: </p>
      <React.Suspense fallback="Loading Button">
        <RemoteButton size='small' type='primary'>RemoteButton</RemoteButton>
      </React.Suspense>

      <p>RemoteTooltip from app1: </p>
      <React.Suspense fallback="Loading Button">
         <RemoteTooltip content='This is tooltip content'>
            <p style={{
                textAlign: 'center',
...
loadRemote('app3/un-existed-module').then(mod=>{
