...
import InstallKit from '@components/common/InstallKit';
...
import CreateConfig from '@components/common/rspress/CreateConfig';

{props.createConfig || <CreateConfig />}

### 注册插件

import RegisterPlugin from '@components/common/rspress/RegisterPlugin';
...
import ConfigType from '@components/common/rspress/ConfigType';
