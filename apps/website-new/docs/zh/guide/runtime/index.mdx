...
- 以下 `Federation Runtime` 示例默认从 `@module-federation/enhanced/runtime` 引用 Runtime API。

- 如果你的项目使用 Modern.js v3，可以改为从 `@module-federation/modern-js-v3/runtime` 引用。

- 如果你的项目使用 Modern.js v2，可以改为从 `@module-federation/modern-js/runtime` 引用。

- 更多接入方式的引用入口，请参考 [如何引用 Runtime API](/integrations#如何引用-runtime-api)。
