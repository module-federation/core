...
其中 Modern.js 插件在 `@module-federation/modern-js-v3/react/data-fetch` 子路径提供了 `lazyLoadComponentPlugin`，因此你不需要额外安装 `@module-federation/bridge-react`。
...
+ import { lazyLoadComponentPlugin } from '@module-federation/modern-js-v3/react/data-fetch';
