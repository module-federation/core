...
核心配置为 [sharedItem.treeShaking](/configure/shared.html#treeshaking)，你也可以通过设置以下配置来控制 Tree Shaking 产物路径：
...
import CreateSharedTreeShakingDeployServer from '@docs/zh/_components/create-shared-tree-shaking-deploy-server.mdx'
...
import SecondaryBuild from '@docs/zh/_components/secondary-build.mdx'
