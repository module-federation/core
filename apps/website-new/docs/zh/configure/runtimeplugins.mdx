...
如果你想看「怎么选 Hook、怎么写常见插件」的任务导向文档，见 [Runtime 插件](/guide/runtime/runtime-plugins.html)。如果你需要完整 Hook 说明，见 [Runtime Hooks](/guide/runtime/runtime-hooks.html)。更底层的插件开发细节，见「[插件系统](/plugin/dev/index.html)」。
