...
我们最近发布了 **[Module Federation enhanced](https://github.com/module-federation/universe)** **v0.1** 版本！
...
- **新版文档**：`Module Federation` 上线了全新的文档，能够帮助你更好的了解和使用 `Module Federation`。
...
- **Rspack**：Rspack 中的 `Module Federation` 基于 `Federation Runtime`，因此能够享受 `Module Federation` 所有额外的能力，并且由于 `Module Federation` 分治的架构思想，你可以将你的大型项目通过 `Module Federation` 渐进式迁移至 `Rspack`。
