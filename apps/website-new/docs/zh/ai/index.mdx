...
加载问题，需要先接入 [观测插件](/plugin/plugins/observability-plugin.html)。
...
1. 先装 `mf`
2. 问一个你当前最关心的问题
3. 需要 MF 加载可观测时，先接入 [观测插件](/plugin/plugins/observability-plugin.html)
4. 再看 [Skills 说明](/ai/skill.html)，了解它支持哪些子命令
