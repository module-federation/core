...
1. Abra [Module Federation Releases](https://github.com/module-federation/core/releases), escolha uma versão estável com o anexo Browser e baixe o ZIP pelas notas ou pela seção **Assets**. O ZIP Browser é publicado com versões `latest`; versões prévias `next` não criam GitHub Releases ou anexos. Não use os arquivos **Source code** gerados automaticamente pelo GitHub.
