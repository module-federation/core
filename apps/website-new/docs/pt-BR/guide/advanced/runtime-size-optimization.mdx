...
Esses defines `FEDERATION_*` ficam até um major futuro. Conditions como `module-federation:no-remote` já podem tirar os módulos correspondentes do grafo, mas as folhas padrão ainda leem esses defines.
