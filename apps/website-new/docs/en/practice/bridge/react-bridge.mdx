...
<PackageManagerTabs
  command={{
    npm: 'npm install @module-federation/bridge-react@0.2.0',
    yarn: 'yarn add @module-federation/bridge-react@0.2.0',
    pnpm: 'pnpm add @module-federation/bridge-react@0.2.0',
  }}
/>
