...
If you only use the Data Loader on the consumption page, then follow [Data Fetch](https://modernjs.dev/en/guides/basic-features/data/data-fetch.html) and [Data Writing] in the Modern.js official website ](https://modernjs.dev/en/guides/basic-features/data/data-write.html) just use it.
