...
| `react.consumerNames` | `string[]` | `[]` | Limit callback injection to specific consumer instances. Empty means no consumer filter. |
...
wrapper component. Keep the matched scope narrow, and remove this option after
