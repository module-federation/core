...
Help users quickly build Module Federation products in **Rsbuild App**.
...
### Note
If you need to use the Module Federation runtime capabilities, please install [@module-federation/enhanced](/guide/runtime/index.html)
...
After generating SSR output with `target: 'dual'`, you can refer to [Create a Modern.js Consumer](/integrations/framework/modernjs/quick-start.html), create a consumer, and integrate the corresponding Rslib SSR producer for development.
