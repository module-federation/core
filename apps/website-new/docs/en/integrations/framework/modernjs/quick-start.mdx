...
This issue can be solved by using the [createremotessrcomponent](/integrations/framework/modernjs#createremotessrcomponent) provided by `@module-federation/modern-js-v3`.
