...
Before getting started, you will need to install [Node.js](https://nodejs.org/), and ensure that your Node.js version is no lower than v20.19.5. **We recommend using the LTS version of Node.js 22.**
