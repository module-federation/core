...
You can learn more about setting up Module Federation with Nx in the guides for [Angular](/integrations/framework/angular/using-nx-for-angular) and [React](/integrations/practice/react/using-nx-for-react).
...
- [[GUIDE]: Using Nx CLI for React](/integrations/practice/react/using-nx-for-react)
