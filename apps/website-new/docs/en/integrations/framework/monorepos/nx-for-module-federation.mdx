...
If you haven't already read the benefits of using a monorepo for Module Federation, make sure to read [Benefits of Module Federation in a Monorepo](/integrations/framework/monorepos/index.html) first.
...
You can learn more about setting up Module Federation with Nx in the guides for [Angular](/integrations/framework/angular/using-nx-for-angular.html) and [React](/integrations/practice/react/using-nx-for-react.html).
...
You can learn more about how we [Scale Developer Experience](/integrations/framework/monorepos/nx-for-module-federation.html#scaling-developer-experience-dx) for Module Federation in Nx below.
...
It also allows you to [develop as a user](/integrations/framework/monorepos/nx-for-module-federation.html#develop-as-a-user) such that you follow the same flow that a user would follow using the deployed application.
...
- [[GUIDE]: Using Nx CLI for React](/integrations/practice/react/using-nx-for-react.html)
- [[GUIDE]: Using Nx CLI for Angular](/integrations/framework/angular/using-nx-for-angular.html)
