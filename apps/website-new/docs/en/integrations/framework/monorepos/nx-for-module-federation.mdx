...
You can learn more about setting up Module Federation with Nx in the guides for [Angular](/integrations/framework/angular/using-nx-for-angular) and [React](/integrations/framework/react/using-nx-for-react).
...
- [[GUIDE]: Using Nx CLI for React](/integrations/framework/react/using-nx-for-react)
- [[GUIDE]: Using Nx CLI for Angular](/integrations/framework/angular/using-nx-for-angular)
