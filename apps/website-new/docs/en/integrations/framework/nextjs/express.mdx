...
If using express, hot server hot module reloading may not work after [these steps](/integrations/framework/nextjs/basic-example.html#step-3-implementing-ssr)
