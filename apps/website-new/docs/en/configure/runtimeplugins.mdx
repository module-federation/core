...
For a task-oriented guide to choosing Hooks and building plugins, see [Runtime Plugins](/guide/runtime/runtime-plugins.html). For the full Hook reference, see [Runtime Hooks](/guide/runtime/runtime-hooks.html). For lower-level plugin authoring details, see the [Plugin System](/plugin/dev/index.html).
