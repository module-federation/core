...
The current page lists all the configuration options for `Module Federation`. Please refer to the documentation for [`Build Plugins`](../guide/basic/plugins/overview) to understand how to use them.
