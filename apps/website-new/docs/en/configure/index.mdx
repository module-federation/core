...
This page lists all configuration options for `Module Federation`. For package installation and plugin setup in different project types, see [Integrations](/integrations/index.html).
