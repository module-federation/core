...
The packages also accept `module-federation:target-web`, `module-federation:target-node`, `module-federation:target-worker`, and `module-federation:target-universal`. Enhanced and Rspack do not set these conditions in this rollout.
