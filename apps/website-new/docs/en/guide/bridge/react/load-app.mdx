...
#### Create Remote Application Component
...
By default, Bridge enables router support to provide the best development experience and compatibility. When you set `enableBridgeRouter: false`, the plugin automatically switches to a build that does not include `react-router-dom`, reducing your bundle size.
