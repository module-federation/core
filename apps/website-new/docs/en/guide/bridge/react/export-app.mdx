...
After completing the export application configuration, you can continue reading [Loading Remote Applications](/guide/bridge/react/load-app.html) to learn how to load this remote application in a host application.
