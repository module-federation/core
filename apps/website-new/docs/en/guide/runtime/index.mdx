...
- The following `Federation Runtime` examples import Runtime APIs from `@module-federation/enhanced/runtime` by default.

- If your project uses Modern.js v3, you can import from `@module-federation/modern-js-v3/runtime` instead.

- If your project uses Modern.js v2, you can import from `@module-federation/modern-js/runtime` instead.

- For import entries used by other integrations, see [How to import Runtime APIs](/integrations#how-to-import-runtime-apis).
