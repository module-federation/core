...
| Observe shared dependency status                 | `afterLoadShare`, `errorLoadShare`                  | You need to diagnose missing shared dependencies, version mismatch, or eager configuration errors                                                                     |
