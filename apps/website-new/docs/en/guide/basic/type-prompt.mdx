...
:::info
When the builder is `webpack`, add `**/@mf-types/**` to [watchOptions.ignored](https://webpack.js.org/configuration/watch/#watchoptionsignored) to avoid circular compilation issues caused by type updates.
:::
...
- [dts](/configure/dts.html): Type generation/loading
- [dev](/configure/dev.html): Type hot reloading
...
2. Set [dts.displayErrorInTerminal](/configure/dts.html#displayerrorinterminal) to `true`.
