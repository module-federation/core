...
By default, parameters are passed to the loader function. The type is [dataFetchParams](../../../practice/bridge/react-bridge/api-reference#datafetchparams), which includes the following field:
