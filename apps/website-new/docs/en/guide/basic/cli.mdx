...
:::note
Once you have completed integration by following an [integration guide](/integrations/index.html), <code>{props.cmdTool || '@module-federation/enhanced'}</code> is typically already in your dependency tree and this command is available out of the box. Otherwise, install it manually in your project before running the commands below.
:::
...
is used to pull or generate TypeScript type declaration files.
