...
```bash
# For npm users
npm add @module-federation/enhanced-rspack --save

# For yarn users
yarn add @module-federation/enhanced-rspack --save

# For pnpm users
pnpm add @module-federation/enhanced-rspack --save

# For bun users
bun add @module-federation/enhanced-rspack --save
```
