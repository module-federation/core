...
```bash
# For npm users
npm add @module-federation/runtime --save

# For yarn users
yarn add @module-federation/runtime --save

# For pnpm users
pnpm add @module-federation/runtime --save

# For bun users
bun add @module-federation/runtime --save
```
