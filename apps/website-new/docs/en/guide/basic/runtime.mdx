...
In addition to exposing APIs, Federation Runtime also provides a FederationHost class, which you can use to create a FederationHost instance.

* When to use `FederationHos` ?
