...
|---|---|---|---|
| [`mf-docs`](#mf-docs) ⭐ | `/mf-docs` | Ask any question about Module Federation 2.0 configuration or APIs | [skills/docs](https://github.com/module-federation/core/tree/main/skills/docs) |
| [`mf-context`](#mf-context) | `/mf-context` | Inspect your project's MF configuration at a glance | [skills/context-fetcher](https://github.com/module-federation/core/tree/main/skills/context-fetcher) |
| [`mf-module-info`](#mf-module-info) | `/mf-module-info` | Inspect a remote module's full info (exposes / remotes / shared) | [skills/module-info](https://github.com/module-federation/core/tree/main/skills/module-info) |
| [`mf-type-check`](#mf-type-check) | `/mf-type-check` | TypeScript type errors or missing `@mf-types` folder | [skills/type-check](https://github.com/module-federation/core/tree/main/skills/type-check) |
| [`mf-shared-deps`](#mf-shared-deps) | `/mf-shared-deps` | Shared deps not working, version conflicts, or duplicate bundling | [skills/shared-deps](https://github.com/module-federation/core/tree/main/skills/shared-deps) |
| [`mf-perf`](#mf-perf) | `/mf-perf` | Slow HMR or slow build speed in local development | [skills/performance](https://github.com/module-federation/core/tree/main/skills/performance) |
| [`mf-config-check`](#mf-config-check) | `/mf-config-check` | Modules are missing from the build output or exposes look wrong | [skills/config-check](https://github.com/module-federation/core/tree/main/skills/config-check) |
| [`mf-bridge-check`](#mf-bridge-check) | `/mf-bridge-check` | Micro-frontend sub-app integration is unstable or throws errors | [skills/bridge-usage](https://github.com/module-federation/core/tree/main/skills/bridge-usage) |
...
- Latest diagnostics from `.mf/diagnostics/latest.json` (if present)
