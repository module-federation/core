...
The core option is [sharedItem.treeShaking](/configure/shared.html#treeshaking). You can also control where Tree Shaking artifacts are generated via:
