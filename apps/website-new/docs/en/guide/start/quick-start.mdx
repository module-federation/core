...
If you wish to learn how to directly export and consume remote modules on Webpack and Rspack build tools, you can refer to: [Rspack Plugin](../build-plugins/plugins-rspack), [Webpack Plugin](../build-plugins/plugins-webpack)
