...
If you wish to learn how to directly export and consume remote modules on Webpack and Rspack build tools, you can refer to: [Rspack Plugin](../basic/plugins/rspack), [Webpack Plugin](../basic/plugins/webpack)
