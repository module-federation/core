...
| rslib                 | A provider using [Rslib](https://lib.rsbuild.dev/)              |
| rslib-storybook       | A provider using [Rslib](https://lib.rsbuild.dev/) with the storybook feature enabled |
...
Templates:
  ...
  provider-modern, provider-rsbuild, rslib, rslib-storybook, consumer-modern, consumer-rsbuild
```
