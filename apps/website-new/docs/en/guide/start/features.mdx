...
| Feature                                                           | Description                                                                                                                                |
| ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [Federation Runtime](../basic/runtime/runtime)                            | Capable of operating independently of build plugins: registering remote modules, consuming remote modules, registering shared dependencies |
| [Build Plugins](../basic/plugins/overview)                                | MF offers a variety of build plugins to help consume and generate remote modules                |
