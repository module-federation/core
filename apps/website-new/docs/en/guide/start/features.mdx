...
| Feature                                                           | Description                                                                                                                                |
| ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| [Federation Runtime](../runtime/index)                            | Capable of operating independently of build plugins: registering remote modules, consuming remote modules, registering shared dependencies |
| [Build Plugins](../build-plugins/plugins)                        | MF offers a variety of build plugins to help consume and generate remote modules                |
