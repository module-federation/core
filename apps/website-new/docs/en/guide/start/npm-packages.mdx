...
It is recommended when you are using other bundlers than webpack and rspack with Module Federation < 2.0. Otherwise, **it is recommended to use @module-federation/enhanced to automatically handle type generation and loading**.
