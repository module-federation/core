...
1. Open [Module Federation Releases](https://github.com/module-federation/core/releases), choose a release containing a Browser extension asset, and download its Browser ZIP from the release notes or **Assets**. Do not download GitHub's automatically generated **Source code** archives.
