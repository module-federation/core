 ...
 * @param {object} moduleObj - The module object (usually 'module') with .hot API
 * @param {object} webpackRequire - The __webpack_require__ function with HMR capabilities
...
module.exports = {
  ...
  applyHotUpdateFromStringsByPatching: applyInMemoryHotUpdate,
};
