...
export default async function build(dir, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false, appDirOnly = false, isTurbopack = false, experimentalBuildMode, traceUploadUrl) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await recordFrameworkVersion("15.3.3");
...
function warnAboutTurbopackBuilds(config) {
    ...
    warningStr += '\n\n- ' + bold('Turbopack currently always builds production sourcemaps for the browser. This will include project sourcecode if deployed to production.');
