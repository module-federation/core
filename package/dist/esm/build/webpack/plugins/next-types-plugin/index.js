        ...
        compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation)=>{
            compilation.hooks.processAssets.tapAsync({
                ...
                if (rootParams.length > 0) {
                    ...
                    compilation.emitAsset(serverTypesPath, new sources.RawSource(createServerDefinitions(rootParams)));
                }
                ...
                if (this.typedRoutes) {
                    ...
                    compilation.emitAsset(linkAssetPath, new sources.RawSource(createRouteDefinitions()));
                }
                if (this.cacheLifeConfig) {
                    const cacheLifeAssetPath = path.join(assetDirRelative, 'types/cache-life.d.ts');
                    compilation.emitAsset(cacheLifeAssetPath, new sources.RawSource(createCustomCacheLifeDefinitions(this.cacheLifeConfig)));
                }
                callback();
            });
        });
