...
const buildClientRemotes = require("./buildClientRemotes");
  ...
  (nextConfig = {}) => {
    ...
    function startCompiler({
      ...
      Object.assign(federationPluginOptions.shared, {
        ...
        "@module-federation/nextjs-mf/lib/noop.js": {
          eager: true,
        },
      });

      const DashboardPlugin = compilation.options.plugins.find((plugin) => {
        return plugin.constructor.name === "NextMedusaPlugin";
      });

      if (DashboardPlugin) {
        filteredPlugins.push(
          new DashboardPlugin.constructor({
      ...
      const webpackOptions = {
        ...
        entry: {
          noop: { import: "@module-federation/nextjs-mf/lib/noop.js" },
        },
        plugins: [
          ...filteredPlugins,
          ...
          config.plugins.push(
            ...
            new webpack.container.ModuleFederationPlugin({
              ...
              exposes: {
                ...
                "./noop": "@module-federation/nextjs-mf/lib/noop.js",
              },
              shared: {
              ...
              remotes: clientRemotes.buildTime,
            })
          );
          /**
