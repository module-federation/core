...
declare class ProgressPlugin {
     ...
     * @returns {void}
     */
    _applyOnMultiCompiler(compiler: MultiCompiler, handler: HandlerFunction): void;
    /**
...
type HandlerFunction = import("../declarations/plugins/ProgressPlugin").HandlerFunction;
