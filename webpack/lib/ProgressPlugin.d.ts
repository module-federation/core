...
declare namespace ProgressPlugin {
    export { defaultOptions, createDefaultHandler, Tap, Hook, ProgressPluginArgument, FactorizeModuleOptions, Dependency, EntryOptions, Module, ModuleFactoryResult, Logger, AsyncQueue, CountsData, HandlerFn, ReportProgress };
}
 ...
 */
declare function createDefaultHandler(profile: boolean | null | undefined, logger: Logger): HandlerFn;
type Tap = import("tapable").Tap;
type Hook<T, R, AdditionalOptions> = import("tapable").Hook<T, R, AdditionalOptions>;
type ProgressPluginArgument = import("../declarations/plugins/ProgressPlugin").ProgressPluginArgument;
