...
declare class RemoteModule extends Module {
     ...
     */
    constructor(request: string, externalRequests: ExternalRequests, internalRequest: string, shareScope: string);
    request: string;
...
declare namespace RemoteModule {
    export { WebpackOptions, Compilation, BuildCallback, CodeGenerationContext, CodeGenerationResult, LibIdentOptions, LibIdent, NameForCondition, NeedBuildCallback, NeedBuildContext, SourceTypes, RequestShortener, ResolverWithOptions, ObjectDeserializerContext, ObjectSerializerContext, InputFileSystem, ExternalRequests };
}
