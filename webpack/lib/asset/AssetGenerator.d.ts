...
declare class AssetGenerator extends Generator {
     ...
     */
    static getSourceFileName(module: NormalModule, runtimeTemplate: RuntimeTemplate): string;
    /**
     * @param {NormalModule} module module
     * @param {RuntimeTemplate} runtimeTemplate runtime template
     * @returns {[string, string]} return full hash and non-numeric full hash
     */
    static getFullContentHash(module: NormalModule, runtimeTemplate: RuntimeTemplate): [string, string];
    /**
     ...
     */
    static getFilenameWithInfo(module: NormalModule, generatorOptions: Pick<AssetResourceGeneratorOptions, "filename" | "outputPath">, { runtime, runtimeTemplate, chunkGraph }: {
        runtime: RuntimeSpec;
     ...
     */
    static getAssetPathWithInfo(module: NormalModule, generatorOptions: Pick<AssetResourceGeneratorOptions, "publicPath">, { runtime, runtimeTemplate, type, chunkGraph, runtimeRequirements }: GenerateContext, filename: string, assetInfo: AssetInfo, contentHash: string): {
        assetPath: string;
        assetInfo: AssetInfo;
    };
    /**
     ...
     */
    constructor(moduleGraph: ModuleGraph, dataUrlOptions?: AssetGeneratorOptions["dataUrl"] | undefined, filename?: AssetModuleFilename | undefined, publicPath?: RawPublicPath | undefined, outputPath?: AssetModuleOutputPath | undefined, emit?: boolean | undefined);
...
declare namespace AssetGenerator {
    export { Source, AssetGeneratorDataUrlOptions, AssetGeneratorOptions, AssetModuleFilename, AssetModuleOutputPath, AssetResourceGeneratorOptions, RawPublicPath, ChunkGraph, AssetInfo, GenerateContext, UpdateHashContext, NameForCondition, BuildInfo, ConcatenationBailoutReasonContext, SourceType, SourceTypes, ModuleGraph, NormalModule, RuntimeTemplate, Hash, RuntimeSpec };
}
import Generator = require("../Generator");
type Source = import("webpack-sources").Source;
type AssetGeneratorDataUrlOptions = import("../../declarations/WebpackOptions").AssetGeneratorDataUrlOptions;
type AssetGeneratorOptions = import("../../declarations/WebpackOptions").AssetGeneratorOptions;
type AssetModuleFilename = import("../../declarations/WebpackOptions").AssetModuleFilename;
type AssetModuleOutputPath = import("../../declarations/WebpackOptions").AssetModuleOutputPath;
