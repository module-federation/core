...
declare class ObjectMatcherRulePlugin {
  ...
  constructor(
    ...
    dataProperty?: keyof EffectData | undefined,
    additionalConditionFunction?: RuleConditionFunction | undefined,
  );
  ruleProperty: ObjectMatcherRuleKeys;
  dataProperty:
    | 'with'
...
type ObjectMatcherRuleKeys = KeysOfTypes<
  RuleSetRule,
  {
