...
declare class BasicMatcherRulePlugin {
     ...
     */
    constructor(ruleProperty: BasicMatcherRuleKeys, dataProperty?: string | undefined, invert?: boolean | undefined);
...
declare namespace BasicMatcherRulePlugin {
    export { RuleSetConditionOrConditions, RuleSetConditionOrConditionsAbsolute, RuleSetRule, RuleSetCompiler, KeysOfTypes, BasicMatcherRuleKeys };
}
type RuleSetConditionOrConditions = import("../../declarations/WebpackOptions").RuleSetConditionOrConditions;
type RuleSetConditionOrConditionsAbsolute = import("../../declarations/WebpackOptions").RuleSetConditionOrConditionsAbsolute;
...
type BasicMatcherRuleKeys = KeysOfTypes<RuleSetRule, RuleSetConditionOrConditions | RuleSetConditionOrConditionsAbsolute>;
