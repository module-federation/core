...
declare class StatsFactory {
    ...
    _caches: Record<"filter" | "sort" | "merge" | "result" | "extract" | "filterSorted" | "groupResults" | "sortResults" | "filterResults" | "getItemName" | "getItemFactory", Map<string, SyncBailHook<[any[], StatsFactoryContext], any, import("tapable").UnsetAdditionalOptions>[]>>;
    _inCreate: boolean;
