...
declare class StatsFactory {
    ...
    _caches: {
        extract: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        filter: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        sort: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        filterSorted: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        groupResults: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        sortResults: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        filterResults: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        merge: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        result: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        getItemName: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
        getItemFactory: Map<string, SyncBailHook<EXPECTED_ANY, EXPECTED_ANY, import("tapable").UnsetAdditionalOptions>[]>;
    };
    _inCreate: boolean;
    /**
     ...
     */
    create<FactoryData, FallbackCreatedObject>(type: string, data: FactoryData, baseContext: Omit<StatsFactoryContext, "type">): CreatedObject<FactoryData, FallbackCreatedObject>;
    /**
     * @private
     * @template FactoryData
     * @template FallbackCreatedObject
...
declare namespace StatsFactory {
    export { Chunk, OriginRecord, Compilation, Asset, NormalizedStatsOptions, Dependency, Module, ModuleProfile, ModuleGraphConnection, WebpackError, Comparator, RuntimeSpec, GroupConfig, ChunkGroupInfoWithName, ModuleIssuerPath, ModuleTrace, StatsAsset, StatsChunk, StatsChunkGroup, StatsChunkOrigin, StatsCompilation, StatsError, StatsModule, StatsModuleIssuer, StatsModuleReason, StatsModuleTraceDependency, StatsModuleTraceItem, StatsProfile, KnownStatsFactoryContext, StatsFactoryContext, StatsObject, CreatedObject, ObjectForExtract, FactoryData, FactoryDataItem, Result, StatsFactoryHooks, Caches };
}
...
type ChunkGroupInfoWithName = import("./DefaultStatsFactoryPlugin").ChunkGroupInfoWithName;
...
type StatsModuleIssuer = import("./DefaultStatsFactoryPlugin").StatsModuleIssuer;
type StatsModuleReason = import("./DefaultStatsFactoryPlugin").StatsModuleReason;
type StatsModuleTraceDependency = import("./DefaultStatsFactoryPlugin").StatsModuleTraceDependency;
type StatsModuleTraceItem = import("./DefaultStatsFactoryPlugin").StatsModuleTraceItem;
...
type StatsFactoryContext = KnownStatsFactoryContext & Record<string, EXPECTED_ANY>;
type StatsObject<T, F> = T extends Compilation ? StatsCompilation : T extends ChunkGroupInfoWithName ? StatsChunkGroup : T extends Chunk ? StatsChunk : T extends OriginRecord ? StatsChunkOrigin : T extends Module ? StatsModule : T extends ModuleGraphConnection ? StatsModuleReason : T extends Asset ? StatsAsset : T extends ModuleTrace ? StatsModuleTraceItem : T extends Dependency ? StatsModuleTraceDependency : T extends Error ? StatsError : T extends ModuleProfile ? StatsProfile : F;
type CreatedObject<T, F> = T extends ChunkGroupInfoWithName[] ? Record<string, StatsObject<ChunkGroupInfoWithName, F>> : T extends (infer V)[] ? StatsObject<V, F>[] : StatsObject<T, F>;
type ObjectForExtract = EXPECTED_ANY;
type FactoryData = EXPECTED_ANY;
type FactoryDataItem = EXPECTED_ANY;
type Result = EXPECTED_ANY;
type StatsFactoryHooks = {
    extract: HookMap<SyncBailHook<[ObjectForExtract, FactoryData, StatsFactoryContext], void>>;
    filter: HookMap<SyncBailHook<[FactoryDataItem, StatsFactoryContext, number, number], boolean | void>>;
    sort: HookMap<SyncBailHook<[Comparator[], StatsFactoryContext], void>>;
    filterSorted: HookMap<SyncBailHook<[FactoryDataItem, StatsFactoryContext, number, number], boolean | void>>;
    groupResults: HookMap<SyncBailHook<[GroupConfig<EXPECTED_ANY, EXPECTED_ANY>[], StatsFactoryContext], void>>;
    sortResults: HookMap<SyncBailHook<[Comparator[], StatsFactoryContext], void>>;
    filterResults: HookMap<SyncBailHook<[FactoryDataItem, StatsFactoryContext, number, number], boolean | void>>;
    merge: HookMap<SyncBailHook<[FactoryDataItem[], StatsFactoryContext], Result | void>>;
    result: HookMap<SyncBailHook<[Result, StatsFactoryContext], Result>>;
    getItemName: HookMap<SyncBailHook<[FactoryDataItem, StatsFactoryContext], string | void>>;
    getItemFactory: HookMap<SyncBailHook<[FactoryDataItem, StatsFactoryContext], StatsFactory | void>>;
};
