...
declare class StatsPrinter {
    ...
    _levelHookCache: Map<StatsPrintHooks[keyof StatsPrintHooks], Map<string, import("tapable").Hook<EXPECTED_ANY, EXPECTED_ANY>[]>>;
    _inPrint: boolean;
    /**
     * get all level hooks
     * @private
     ...
     */
    print(type: string, object: PrintObject, baseContext?: StatsPrinterContext | undefined): string | undefined;
    /**
     * @private
     * @param {string} type type
...
declare namespace StatsPrinter {
    export { StatsAsset, StatsChunk, StatsChunkGroup, StatsCompilation, StatsError, StatsLogging, StatsModule, StatsModuleIssuer, StatsModuleReason, StatsModuleTraceDependency, StatsModuleTraceItem, StatsProfile, PrintedElement, KnownStatsPrinterContext, ColorFunction, KnownStatsPrinterColorFunctions, KnownStatsPrinterFormatters, StatsPrinterContext, StatsPrinterContextWithExtra, PrintObject, StatsPrintHooks };
}
...
type KnownStatsPrinterFormatters = {
    ...
    formatChunkId?: ((id: string | number, direction?: "parent" | "child" | "sibling") => string) | undefined;
...
type StatsPrinterContext = KnownStatsPrinterColorFunctions & KnownStatsPrinterFormatters & KnownStatsPrinterContext & Record<string, EXPECTED_ANY>;
type StatsPrinterContextWithExtra = StatsPrinterContext & Required<KnownStatsPrinterColorFunctions> & Required<KnownStatsPrinterFormatters> & {
    type: string;
};
type PrintObject = EXPECTED_ANY;
type StatsPrintHooks = {
    sortElements: HookMap<SyncBailHook<[string[], StatsPrinterContext], void>>;
    printElements: HookMap<SyncBailHook<[PrintedElement[], StatsPrinterContext], string | undefined | void>>;
    sortItems: HookMap<SyncBailHook<[PrintObject[], StatsPrinterContext], boolean | void>>;
    getItemName: HookMap<SyncBailHook<[PrintObject, StatsPrinterContext], string | void>>;
    printItems: HookMap<SyncBailHook<[string[], StatsPrinterContext], string | undefined>>;
    print: HookMap<SyncBailHook<[PrintObject, StatsPrinterContext], string | undefined | void>>;
