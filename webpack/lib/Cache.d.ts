...
declare class Cache {
    hooks: {
        ...
        get: AsyncSeriesBailHook<[string, Etag | null, GotHandler<EXPECTED_ANY>[]], Data>;
...
declare namespace Cache {
    export { STAGE_MEMORY, STAGE_DEFAULT, STAGE_DISK, STAGE_NETWORK, WebpackError, Etag, CallbackCache, Data, GotHandler };
}
...
type CallbackCache<T> = (err: WebpackError | null, result?: T | undefined) => void;
