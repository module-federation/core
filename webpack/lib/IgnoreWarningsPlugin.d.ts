...
declare class IgnoreWarningsPlugin {
     ...
     */
    constructor(ignoreWarnings: import("../declarations/WebpackOptions").IgnoreWarningsNormalized);
...
type IgnoreWarningsNormalized = import("../declarations/WebpackOptions").IgnoreWarningsNormalized;
