...
declare class MainTemplate {
    ...
    hooks: Readonly<{
        ...
        readonly jsonpScript: SyncWaterfallHook<[string, import("./Chunk")], import("tapable").UnsetAdditionalOptions>;
        readonly linkPrefetch: SyncWaterfallHook<[string, import("./Chunk")], import("tapable").UnsetAdditionalOptions>;
        readonly linkPreload: SyncWaterfallHook<[string, import("./Chunk")], import("tapable").UnsetAdditionalOptions>;
    }>;
