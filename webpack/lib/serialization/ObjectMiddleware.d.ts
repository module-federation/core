 ...
 */
declare class ObjectMiddleware extends SerializerMiddleware<DeserializedType, SerializedType, Context> {
    /**
     ...
     * @returns {void}
     */
    static registerLoader(regExp: RegExp, loader: (request: string) => boolean): void;
    /**
     ...
     */
    static _getDeserializerForWithoutError(request: string, name: string): ObjectSerializer | undefined;
    /**
     * @param {(context: ObjectSerializerContext | ObjectDeserializerContext) => void} extendContext context extensions
     * @param {string | Hash} hashFunction hash function to use
     */
    constructor(extendContext: (context: ObjectSerializerContext | ObjectDeserializerContext) => void, hashFunction?: string | Hash);
    extendContext: (context: ObjectSerializerContext | ObjectDeserializerContext) => void;
    _hashFunction: string | typeof import("../util/Hash");
}
declare namespace ObjectMiddleware {
    export { NOT_SERIALIZABLE, Logger, Hash, LazyOptions, ComplexSerializableType, PrimitiveSerializableType, Constructor, ObjectSerializerSnapshot, ReferenceableItem, ObjectSerializerContext, ObjectDeserializerContext, ObjectSerializer, SerializerConfig, SerializerConfigWithSerializer, DeserializedType, SerializedType, Context };
}
...
type ObjectSerializerContext = {
    ...
    writeSeparate?: ((item: (EXPECTED_ANY | (() => EXPECTED_ANY)), obj: LazyOptions | undefined) => import("./SerializerMiddleware").LazyFunction<EXPECTED_ANY, EXPECTED_ANY, EXPECTED_ANY, LazyOptions>) | undefined;
};
