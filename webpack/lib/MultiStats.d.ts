...
declare class MultiStats {
     ...
     */
    _createChildOptions(options: undefined | string | boolean | MultiStatsOptions, context: CreateStatsOptionsContext): ChildOptions;
    /**
     * @param {(string | boolean | MultiStatsOptions)=} options stats options
     * @returns {StatsCompilation} json output
     */
    toJson(options?: (string | boolean | MultiStatsOptions) | undefined): StatsCompilation;
    /**
     * @param {(string | boolean | MultiStatsOptions)=} options stats options
     * @returns {string} string output
     */
    toString(options?: (string | boolean | MultiStatsOptions) | undefined): string;
}
declare namespace MultiStats {
    export { StatsOptions, CreateStatsOptionsContext, NormalizedStatsOptions, Stats, KnownStatsCompilation, StatsCompilation, StatsError, ChildrenStatsOptions, MultiStatsOptions, ChildOptions };
}
