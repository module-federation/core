...
declare class ChunkGraph {
     ...
     * @returns {Iterable<Chunk>} iterable of chunks (do not modify)
     */
    getOrderedModuleChunksIterable(module: Module, sortFn: (a: Chunk, b: Chunk) => -1 | 0 | 1): Iterable<Chunk>;
    /**
     * @param {Module} module the module
     ...
     */
    setChunkModuleSourceTypes(chunk: Chunk, module: Module, sourceTypes: SourceTypes): void;
    /**
     * @param {Chunk} chunk chunk
     * @param {Module} module chunk module
     ...
     * @returns {Iterable<Module>} return the modules for this chunk
     */
    getOrderedChunkModulesIterable(chunk: Chunk, comparator: ModuleComparator): Iterable<Module>;
    /**
     * @param {Chunk} chunk the chunk
     * @param {string} sourceType source type
     * @param {ModuleComparator} comparator comparator function
     * @returns {Iterable<Module> | undefined} return the modules for this chunk
     */
    getOrderedChunkModulesIterableBySourceType(chunk: Chunk, sourceType: string, comparator: ModuleComparator): Iterable<Module> | undefined;
    /**
     * @param {Chunk} chunk the chunk
     ...
     */
    getChunkModuleIdMap(chunk: Chunk, filterFn: ModuleFilterPredicate, includeAllChunks?: boolean): ChunkModuleIdMap;
    /**
     * @param {Chunk} chunk the chunk
     * @param {ModuleFilterPredicate} filterFn function used to filter modules
     ...
     */
    getChunkModuleRenderedHashMap(chunk: Chunk, filterFn: ModuleFilterPredicate, hashLength?: number, includeAllChunks?: boolean): ChunkModuleHashMap;
    /**
     * @param {Chunk} chunk the chunk
     * @param {ChunkFilterPredicate} filterFn function used to filter chunks
     * @returns {Record<ChunkId, boolean>} chunk map
     */
    getChunkConditionMap(chunk: Chunk, filterFn: ChunkFilterPredicate): Record<ChunkId, boolean>;
    /**
     * @param {Chunk} chunk the chunk
     ...
     * @returns {T} hash
     */
    _getModuleHashInfo<T_1>(module: Module, hashes: RuntimeSpecMap<T_1>, runtime: RuntimeSpec): T_1;
    /**
     * @param {Module} module the module
     * @param {RuntimeSpec} runtime the runtime
     ...
     * @returns {void}
     */
    addModuleRuntimeRequirements(module: Module, runtime: RuntimeSpec, items: RuntimeRequirements, transferOwnership?: boolean): void;
    /**
     * @param {Chunk} chunk the chunk
     ...
     */
    getModuleRuntimeRequirements(module: Module, runtime: RuntimeSpec): ReadOnlyRuntimeRequirements;
    /**
     * @param {Chunk} chunk the chunk
     * @returns {ReadOnlyRuntimeRequirements} runtime requirements
     */
...
declare namespace ChunkGraph {
    export { AsyncDependenciesBlock, Chunk, Chunks, Entrypoints, ChunkId, ChunkGroup, Module, SourceType, SourceTypes, ReadOnlyRuntimeRequirements, RuntimeRequirements, ModuleGraph, ConnectionState, RuntimeModule, Hash, RuntimeSpec, ChunkFilterPredicate, ModuleFilterPredicate, EntryModuleWithChunkGroup, ChunkSizeOptions, ModuleSetToArrayFunction, SortableChunks, EntryInChunks, RuntimeInChunks, ModuleId, SourceTypesByModule, EntryModules, RuntimeId, IdToHashMap, ChunkModuleHashMap, ChunkModuleIdMap, ModuleComparator };
}
...
declare class ChunkGraphModule {
    ...
    runtimeRequirements: RuntimeSpecMap<Set<string>, RuntimeRequirements> | undefined;
