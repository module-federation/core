...
declare class JavascriptParser extends Parser {
     ...
     */
    callHooksForExpressionWithFallback<T, R>(hookMap: HookMap<SyncBailHook<T, R, import("tapable").UnsetAdditionalOptions>>, expr: MemberExpression, fallback: (arg0: string, arg1: string | ScopeInfo | VariableInfo, arg2: () => string[]) => any, defined: (arg0: string) => any, ...args: import("tapable").AsArray<T>): R;
    /**
     * @template T
     * @template R
     * @param {HookMap<SyncBailHook<T, R>>} hookMap hooks the should be called
     ...
     * @returns {R | undefined} result of hook
     */
    callHooksForInfoWithFallback<T_3, R_3>(hookMap: HookMap<SyncBailHook<T_3, R_3, import("tapable").UnsetAdditionalOptions>>, info: ExportedVariableInfo, fallback: (arg0: string) => any, defined: () => any, ...args: import("tapable").AsArray<T_3>): R_3;
    /**
     * @template T
     * @template R
     * @param {HookMap<SyncBailHook<T, R>>} hookMap hooks the should be called
     ...
     * @returns {R | undefined} result of hook
     */
    callHooksForNameWithFallback<T_4, R_4>(hookMap: HookMap<SyncBailHook<T_4, R_4, import("tapable").UnsetAdditionalOptions>>, name: string, fallback: (arg0: string) => any, defined: () => any, ...args: import("tapable").AsArray<T_4>): R_4;
    /**
     * @deprecated
