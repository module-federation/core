export function generateEntryStartup(chunkGraph: ChunkGraph, runtimeTemplate: RuntimeTemplate, entries: import("../ChunkGraph").EntryModuleWithChunkGroup[], chunk: Chunk, passive: boolean): string;
export function updateHashForEntryStartup(hash: Hash, chunkGraph: ChunkGraph, entries: import("../ChunkGraph").EntryModuleWithChunkGroup[], chunk: Chunk): void;
