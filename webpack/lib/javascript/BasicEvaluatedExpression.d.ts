...
declare class BasicEvaluatedExpression {
     ...
     * @returns {this} this
     */
    setIdentifier(identifier: string | VariableInfoInterface, rootInfo: string | VariableInfoInterface, getMembers: () => string[], getMembersOptionals?: () => boolean[], getMemberRanges?: () => import("./JavascriptParser").Range[]): this;
    /**
