...
declare class JavascriptGenerator extends Generator {
     ...
     * @returns {void}
     */
    sourceDependency(module: Module, dependency: Dependency, initFragments: InitFragment<GenerateContext>[], source: ReplaceSource, generateContext: GenerateContext): void;
    /**
     ...
     * @returns {void}
     */
    sourceBlock(module: Module, block: DependenciesBlock, initFragments: InitFragment<GenerateContext>[], source: ReplaceSource, generateContext: GenerateContext): void;
    /**
     * @param {Module} module the module to generate
     * @param {InitFragment<GenerateContext>[]} initFragments mutable list of init fragments
     * @param {ReplaceSource} source the current replace source which can be modified
     ...
     * @returns {void}
     */
    sourceModule(module: Module, initFragments: InitFragment<GenerateContext>[], source: ReplaceSource, generateContext: GenerateContext): void;
    /**
...
declare namespace JavascriptGenerator {
    export { Source, DependencyConstructor, DependenciesBlock, Dependency, DependencyTemplate, DependencyTemplateContext, GenerateContext, Module, ConcatenationBailoutReasonContext, SourceType, SourceTypes, NormalModule };
}
