...
declare namespace LazyCompilationPlugin {
    export { WebpackOptions, Compilation, Compiler, UpdateHashContext, BuildCallback, BuildMeta, CodeGenerationContext, CodeGenerationResult, LibIdentOptions, LibIdent, NeedBuildCallback, NeedBuildContext, SourceTypes, ModuleFactoryCallback, ModuleFactoryCreateData, RequestShortener, ResolverWithOptions, HarmonyImportDependency, Hash, InputFileSystem, ModuleResult, BackendApi, BackendHandler, PromiseBackendHandler, BackEnd, TestFn, Options };
}
...
type BackendHandler = (compiler: Compiler, callback: (err: Error | null, backendApi?: BackendApi) => void) => void;
