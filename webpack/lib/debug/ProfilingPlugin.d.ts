...
declare namespace ProfilingPlugin {
    export { Profiler, Session, FullTap, ProfilingPluginOptions, Compilation, Compiler, NormalModuleFactory, ResolverFactory, IntermediateFileSystem, Hook, FakeHook, HookMap, HookInterceptor, Inspector, Trace, Hooks, PluginFunction };
}
declare class Profiler {
     ...
     */
    sendCommand(method: string, params?: EXPECTED_OBJECT | undefined): Promise<EXPECTED_ANY | void>;
...
type Hooks = Record<string, Hook<EXPECTED_ANY, EXPECTED_ANY> | FakeHook<EXPECTED_ANY> | HookMap<EXPECTED_ANY>>;
type PluginFunction = (...args: EXPECTED_ANY[]) => EXPECTED_ANY | Promise<(...args: EXPECTED_ANY[]) => EXPECTED_ANY>;
