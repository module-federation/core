...
declare class Generator {
     ...
     * @returns {Source | null} generated code
     */
    generate(module: NormalModule, { dependencyTemplates, runtimeTemplate, moduleGraph, type }: GenerateContext): Source | null;
    /**
...
declare namespace Generator {
    export { Source, ChunkGraph, CodeGenerationResults, ConcatenationScope, DependencyTemplates, CodeGenerationResultData, ConcatenationBailoutReasonContext, RuntimeRequirements, SourceType, SourceTypes, ModuleGraph, NormalModule, RuntimeTemplate, Hash, RuntimeSpec, GenerateContext, GenerateErrorFn, UpdateHashContext };
}
...
type GenerateErrorFn = (error: Error, module: NormalModule, generateContext: GenerateContext) => Source | null;
