 ...
 */
export const ASSET_AND_JAVASCRIPT_AND_CSS_URL_TYPES: ReadonlySet<
  'javascript' | 'css-url' | 'asset'
>;
/**
 * @type {ReadonlySet<"asset" | "javascript" | "asset">}
 */
export const ASSET_AND_JAVASCRIPT_TYPES: ReadonlySet<
 ...
 */
export const JAVASCRIPT_AND_CSS_URL_TYPES: ReadonlySet<
  'javascript' | 'css-url'
>;
/**
