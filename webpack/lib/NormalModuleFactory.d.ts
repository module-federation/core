...
declare class NormalModuleFactory extends ModuleFactory {
  ...
  hooks: Readonly<{
    ...
    createParser: import('tapable').TypedHookMap<
      RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [2], 1>
    >;
    /** @type {import("tapable").TypedHookMap<RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [1, 2]>>} */
    parser: import('tapable').TypedHookMap<
      RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [1, 2]>
    >;
    /** @type {import("tapable").TypedHookMap<RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [4], 3>>} */
    createGenerator: import('tapable').TypedHookMap<
      RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [4], 3>
    >;
    /** @type {import("tapable").TypedHookMap<RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [3, 4]>>} */
    generator: import('tapable').TypedHookMap<
      RecordFactoryFromTuple<ParsersAndGeneratorsByTypes, [3, 4]>
    >;
    /** @type {HookMap<SyncBailHook<[CreateData, ResolveData], Module | void>>} */
    createModuleClass: HookMap<
      SyncBailHook<[CreateData, ResolveData], Module | void>
    >;
  }>;
...
type EmptyGeneratorOptions =
  import('../declarations/WebpackOptions').EmptyGeneratorOptions;
type JsonParser = import('./json/JsonParser');
type JsonParserOptions =
  import('../declarations/WebpackOptions').JsonParserOptions;
type JsonGenerator = import('./json/JsonGenerator');
type JsonGeneratorOptions =
  import('../declarations/WebpackOptions').JsonGeneratorOptions;
...
type EmptyParserOptions =
  import('../declarations/WebpackOptions').EmptyParserOptions;
...
type AssetInlineGeneratorOptions =
  import('../declarations/WebpackOptions').AssetInlineGeneratorOptions;
...
type CssParserOptions =
  import('../declarations/WebpackOptions').CssParserOptions;
type CssModuleParserOptions =
  import('../declarations/WebpackOptions').CssModuleParserOptions;
type CssGenerator = import('./css/CssGenerator');
type CssGeneratorOptions =
  import('../declarations/WebpackOptions').CssGeneratorOptions;
type CssModuleGeneratorOptions =
  import('../declarations/WebpackOptions').CssModuleGeneratorOptions;
type ParsersAndGeneratorsByTypes = [
  [
    JAVASCRIPT_MODULE_TYPE_AUTO,
    JavascriptParser,
    JavascriptParserOptions,
...
type ExtractTupleElements<T extends unknown[], I extends number[]> = {
  [K in keyof I]: K extends keyof I
    ? I[K] extends keyof T
      ? T[I[K]]
      : never
    : never;
};
type RecordFactoryFromTuple<
  T extends unknown[],
  A extends number[],
  R = void,
> = T extends [
  infer Head extends [string, ...unknown[]],
  ...infer Tail extends [string, ...unknown[]][],
]
  ? Record<
      Head[0],
      SyncBailHook<
        ExtractTupleElements<Head, A>,
        R extends number ? Head[R] : R
      >
    > &
      RecordFactoryFromTuple<Tail, A, R>
  : unknown;
