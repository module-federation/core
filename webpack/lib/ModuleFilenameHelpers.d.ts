 ...
 */
export function createFilename(module: Module | string, options: {
    namespace?: string;
 ...
 * ```
 */
export function replaceDuplicates<T>(array: T[], fn: (duplicateItem: T, duplicateItemIndex: number, numberOfTimesReplaced: number) => T, comparator?: ((firstElement: T, nextElement: T) => -1 | 0 | 1) | undefined): T[];
/**
...
export type HashFunction = import("../declarations/WebpackOptions").HashFunction;
...
export type ModuleFilenameTemplateFunction = ((context: ModuleFilenameTemplateContext) => string);
