 ...
 */
declare class ConditionalInitFragment extends InitFragment<import("./Generator").GenerateContext> {
    /**
     ...
     */
    constructor(content: string | Source | undefined, stage: number, position: number, key: string | undefined, runtimeCondition?: RuntimeSpec | boolean, endContent?: (string | Source) | undefined);
...
declare namespace ConditionalInitFragment {
    export { Source, GenerateContext, RuntimeSpec };
}
