...
declare namespace VirtualUrlPlugin {
    export { DEFAULT_SCHEME, SourceFn, VersionFn, VirtualModuleConfig, VirtualModuleInput, VirtualModules, Compiler, NormalModule, LoaderContext, VirtualUrlPluginOptions };
}
declare const DEFAULT_SCHEME: "virtual";
type SourceFn = (loaderContext: LoaderContext<EXPECTED_ANY>) => Promise<string | Buffer> | string | Buffer;
