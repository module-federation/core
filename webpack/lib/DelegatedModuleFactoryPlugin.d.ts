...
declare namespace DelegatedModuleFactoryPlugin {
    export { DllReferencePluginOptions, DllReferencePluginOptionsContent, DelegatedModuleSourceRequest, DelegatedModuleType, NormalModuleFactory, AssociatedObjectForCache, Options };
}
...
type DelegatedModuleSourceRequest = import("./DelegatedModule").DelegatedModuleSourceRequest;
