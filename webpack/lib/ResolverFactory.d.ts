...
type WebpackResolveOptions = import("../declarations/WebpackOptions").ResolveOptions;
type ResolvePluginInstance = import("../declarations/WebpackOptions").ResolvePluginInstance;
type WithOptions = {
    /**
