 ...
 */
declare function webpack(options: WebpackOptions, callback: Callback<Stats>): Compiler | null;
/**
 * @overload
 * @param {WebpackOptions} options options object
 ...
 */
declare function webpack(options: MultiWebpackOptions, callback: Callback<MultiStats>): MultiCompiler | null;
/**
 * @overload
 * @param {MultiWebpackOptions} options options objects
...
declare namespace webpack {
    export { WebpackOptions, WebpackPluginFunction, WebpackOptionsNormalizedWithDefaults, WatchOptions, MultiCompilerOptions, MultiWebpackOptions, MultiStats, Stats, Callback, ErrorCallback };
}
...
type WebpackOptionsNormalizedWithDefaults = import("./config/defaults").WebpackOptionsNormalizedWithDefaults;
