...
declare class ChunkGroup {
     ...
     * @returns {void}
     */
    addOrigin(module: Module | null, loc: DependencyLocation, request: string): void;
    /**
...
declare namespace ChunkGroup {
    export { AsyncDependenciesBlock, Chunk, ChunkGraph, DependencyLocation, Entrypoint, Module, ModuleGraph, OriginRecord, RawChunkGroupOptions, ChunkGroupOptions };
}
