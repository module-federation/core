...
type EntryDescriptionNormalized = import("../declarations/WebpackOptions").EntryDescriptionNormalized;
type EntryDynamic = import("../declarations/WebpackOptions").EntryDynamicNormalized;
