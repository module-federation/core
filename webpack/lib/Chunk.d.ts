...
declare class Chunk {
     ...
     */
    getChildIdsByOrders(chunkGraph: ChunkGraph, filterFn?: ChunkFilterPredicate | undefined): Record<string, ChunkId[]>;
    /**
     * @param {ChunkGraph} chunkGraph the chunk graph
     ...
     */
    getChildIdsByOrdersMap(chunkGraph: ChunkGraph, includeDirectChildren?: boolean | undefined, filterFn?: ChunkFilterPredicate | undefined): ChunkChildIdsByOrdersMapByData;
    /**
     * @param {ChunkGraph} chunkGraph the chunk graph
     * @param {string} type option name
     * @param {boolean=} includeDirectChildren include direct children (by default only children of async children are included)
     ...
     */
    hasChildByOrder(chunkGraph: ChunkGraph, type: string, includeDirectChildren?: boolean | undefined, filterFn?: ChunkFilterPredicate | undefined): boolean;
}
declare namespace Chunk {
    export { ChunkFilterPredicate, ChunkSizeOptions, ModuleFilterPredicate, ModuleId, ChunkGroup, ChunkGroupOptions, EntryOptions, Module, TemplatePath, Hash, RuntimeSpec, ChunkName, ChunkId, IdNameHints, ChunkMaps, ChunkModuleIdMap, chunkModuleHashMap, ChunkModuleMaps, Chunks, Entrypoints, Queue, SortableChunkGroups, ChunkChildIdsByOrdersMap, ChunkChildIdsByOrdersMapByData };
}
