...
declare namespace ManifestPlugin {
    export { Compiler, Chunk, ChunkName, ChunkId, Asset, AssetInfo, ManifestPluginOptions, ManifestObject, ManifestEntrypoint, ManifestItem };
}
...
type ManifestPluginOptions = import("../declarations/plugins/ManifestPlugin").ManifestPluginOptions;
type ManifestObject = import("../declarations/plugins/ManifestPlugin").ManifestObject;
type ManifestEntrypoint = import("../declarations/plugins/ManifestPlugin").ManifestEntrypoint;
type ManifestItem = import("../declarations/plugins/ManifestPlugin").ManifestItem;
