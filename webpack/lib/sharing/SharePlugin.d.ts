...
declare class SharePlugin {
    ...
    _shareScope: string;
    _consumes: Record<string, import("../../declarations/plugins/sharing/ConsumeSharedPlugin").ConsumesConfig>[];
    _provides: Record<string, import("../../declarations/plugins/sharing/ProvideSharedPlugin").ProvidesConfig>[];
    /**
     * Apply the plugin
...
type SharePluginOptions = import("../../declarations/plugins/sharing/SharePlugin").SharePluginOptions;
type ConsumeSharedPluginOptions = import("../../declarations/plugins/sharing/ConsumeSharedPlugin").ConsumeSharedPluginOptions;
type ConsumesConfig = import("../../declarations/plugins/sharing/ConsumeSharedPlugin").ConsumesConfig;
type ProvideSharedPluginOptions = import("../../declarations/plugins/sharing/ProvideSharedPlugin").ProvideSharedPluginOptions;
type ProvidesConfig = import("../../declarations/plugins/sharing/ProvideSharedPlugin").ProvidesConfig;
type SharedConfig = import("../../declarations/plugins/sharing/SharePlugin").SharedConfig;
