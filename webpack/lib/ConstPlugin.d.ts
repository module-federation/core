...
declare class ConstPlugin {
     ...
     * @returns {void}
     */
    eliminateUnusedStatement(parser: JavascriptParser, statement: Statement, alwaysInBlock: boolean): void;
}
declare namespace ConstPlugin {
    export { AssignmentProperty, Expression, Identifier, Pattern, SourceLocation, Statement, Super, VariableDeclaration, Compiler, JavascriptParser, Range, Declarations };
}
