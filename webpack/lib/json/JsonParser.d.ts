...
declare namespace JsonParser {
    export { JsonModulesPluginParserOptions, BuildInfo, BuildMeta, ParserState, PreparsedAst, JsonValue, ParseFn };
}
import Parser = require("../Parser");
type JsonModulesPluginParserOptions = import("../../declarations/plugins/JsonModulesPluginParser").JsonModulesPluginParserOptions;
