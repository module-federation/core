...
declare class GetChunkFilenameRuntimeModule extends RuntimeModule {
     ...
     */
    constructor(contentType: string, name: string, global: string, getFilenameForChunk: (chunk: Chunk) => TemplatePath | false, allChunks: boolean);
    contentType: string;
    global: string;
...
declare namespace GetChunkFilenameRuntimeModule {
    export { Chunk, ChunkId, ChunkGraph, Compilation, HashWithLengthFunction, TemplatePath };
}
