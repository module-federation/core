...
declare namespace WasmChunkLoadingRuntimeModule {
    export { Signature, Chunk, ChunkGraph, ModuleId, Compilation, Module, ReadOnlyRuntimeRequirements, ModuleGraph, RuntimeSpec, Declarations, WasmChunkLoadingRuntimeModuleOptions };
}
