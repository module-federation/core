...
declare namespace TemplatedPathPlugin {
    export { ChunkGraph, ModuleId, AssetInfo, PathData, Compiler, ReplacerFunction, Replacer, TemplatePathFn, TemplatePath };
}
...
type ReplacerFunction = (match: string, arg: string | undefined, input: string) => any;
type Replacer = (match: string, arg: string | undefined, input: string) => string;
