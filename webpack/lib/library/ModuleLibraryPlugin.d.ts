...
declare namespace ModuleLibraryPlugin {
    export { Source, LibraryOptions, LibraryType, LibraryExport, Chunk, Compiler, Module, BuildMeta, RuntimeRequirements, StartupRenderContext, ModuleRenderContext, LibraryContext, ModuleLibraryPluginOptions, ModuleLibraryPluginParsed, T };
}
