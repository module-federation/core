...
declare class AbstractLibraryPlugin<T> {
     ...
     */
    render(source: any, renderContext: RenderContext, libraryContext: LibraryContext<T>): any;
    /**
     * @param {Source} source source
     ...
     * @returns {Source} source with library export
     */
    renderStartup(source: any, module: Module, renderContext: StartupRenderContext, libraryContext: LibraryContext<T>): any;
    /**
     * @param {Chunk} chunk the chunk
