...
declare class AssignLibraryPlugin extends AbstractLibraryPlugin<AssignLibraryPluginParsed> {
     ...
     */
    _getResolvedFullName(options: AssignLibraryPluginParsed, chunk: Chunk, compilation: Compilation): string[];
}
declare namespace AssignLibraryPlugin {
    export { Source, LibraryOptions, LibraryType, LibraryExport, Chunk, Compilation, ChunkHashContext, Module, RuntimeRequirements, ExportInfoName, RenderContext, StartupRenderContext, Hash, LibraryContext, LibraryPrefix, AssignLibraryPluginOptions, LibraryName, AssignLibraryPluginParsed, T };
}
