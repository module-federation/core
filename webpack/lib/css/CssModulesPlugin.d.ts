...
declare class CssModulesPlugin {
     ...
     */
    static getChunkFilenameTemplate(chunk: Chunk, outputOptions: OutputOptions): Chunk["cssFilenameTemplate"] | OutputOptions["cssFilename"] | OutputOptions["cssChunkFilename"];
    /**
     * @param {Chunk} chunk chunk
...
type CssExperimentOptions = import("../../declarations/WebpackOptions").CssExperimentOptions;
type Source = any;
