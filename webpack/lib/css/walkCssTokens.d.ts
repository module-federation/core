...
declare function _exports(input: string, pos?: number | undefined, callbacks?: CssTokenCallbacks | undefined): number;
declare namespace _exports {
    export { consumeUntil };
    export { eatComments };
...
type CssTokenCallbacks = {
    url?: ((input: string, start: number, end: number, innerStart: number, innerEnd: number) => number) | undefined;
    ...
    leftCurlyBracket?: ((input: string, start: number, end: number) => number) | undefined;
    rightCurlyBracket?: ((input: string, start: number, end: number) => number) | undefined;
    leftParenthesis?: ((input: string, start: number, end: number) => number) | undefined;
    rightParenthesis?: ((input: string, start: number, end: number) => number) | undefined;
    leftSquareBracket?: ((input: string, start: number, end: number) => number) | undefined;
    rightSquareBracket?: ((input: string, start: number, end: number) => number) | undefined;
    function?: ((input: string, start: number, end: number) => number) | undefined;
    colon?: ((input: string, start: number, end: number) => number) | undefined;
    atKeyword?: ((input: string, start: number, end: number) => number) | undefined;
    delim?: ((input: string, start: number, end: number) => number) | undefined;
    identifier?: ((input: string, start: number, end: number) => number) | undefined;
    hash?: ((input: string, start: number, end: number, isId: boolean) => number) | undefined;
    semicolon?: ((input: string, start: number, end: number) => number) | undefined;
    comma?: ((input: string, start: number, end: number) => number) | undefined;
    needTerminate?: (() => boolean) | undefined;
};
type CharHandler = (input: string, pos: number, callbacks: CssTokenCallbacks) => number;
/**
 ...
 * @returns {number} pos
 */
declare function consumeUntil(input: string, pos: number, callbacks: CssTokenCallbacks, additional?: CssTokenCallbacks | undefined, options?: {
 ...
 */
declare function eatIdentSequence(input: string, pos: number): [number, number] | undefined;
/**
 * @param {string} input input
 * @param {number} pos position
 * @returns {[number, number, boolean] | undefined} positions of ident sequence or string
 */
declare function eatIdentSequenceOrString(input: string, pos: number): [number, number, boolean] | undefined;
/**
 * @param {string} input input
 * @param {number} pos position
 ...
 */
declare function eatImageSetStrings(input: string, pos: number, cbs: CssTokenCallbacks): [number, number][];
/**
 * @param {string} input input
 * @param {number} pos position
 * @param {CssTokenCallbacks} cbs callbacks
 ...
 */
declare function eatImportTokens(input: string, pos: number, cbs: CssTokenCallbacks): [[number, number, number, number] | undefined, [number, number] | undefined, [number, number] | undefined, [number, number] | undefined];
/**
 * @param {string} input input
 * @param {number} pos position
 * @returns {[number, number] | undefined} positions of ident sequence
 */
declare function eatString(input: string, pos: number): [number, number] | undefined;
/**
 * @param {string} chars characters
 * @returns {(input: string, pos: number) => number} function to eat characters
 */
declare function eatUntil(chars: string): (input: string, pos: number) => number;
/**
 * @param {string} input input
 * @param {number} pos position
 ...
 */
declare function eatWhitespaceAndComments(input: string, pos: number): [number, boolean];
/**
 ...
 * @returns {[number, number] | undefined} positions of ident sequence
 */
declare function skipCommentsAndEatIdentSequence(input: string, pos: number): [number, number] | undefined;
