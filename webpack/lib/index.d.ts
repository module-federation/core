declare const _exports: import("./webpack").WebpackFunctionSingle & import("./webpack").WebpackFunctionMulti & {
...
export type EntryNormalized = import("../declarations/WebpackOptions").EntryNormalized;
export type EntryObject = import("../declarations/WebpackOptions").EntryObject;
export type ExternalItemFunctionData = import("../declarations/WebpackOptions").ExternalItemFunctionData;
export type ExternalItemObjectKnown = import("../declarations/WebpackOptions").ExternalItemObjectKnown;
export type ExternalItemObjectUnknown = import("../declarations/WebpackOptions").ExternalItemObjectUnknown;
export type ExternalItemValue = import("../declarations/WebpackOptions").ExternalItemValue;
...
export type LibraryOptions = import("../declarations/WebpackOptions").LibraryOptions;
export type MemoryCacheOptions = import("../declarations/WebpackOptions").MemoryCacheOptions;
export type ModuleOptions = import("../declarations/WebpackOptions").ModuleOptions;
export type ResolveOptions = import("../declarations/WebpackOptions").ResolveOptions;
export type RuleSetCondition = import("../declarations/WebpackOptions").RuleSetCondition;
export type RuleSetConditionAbsolute = import("../declarations/WebpackOptions").RuleSetConditionAbsolute;
...
export type RuleSetUseItem = import("../declarations/WebpackOptions").RuleSetUseItem;
export type StatsOptions = import("../declarations/WebpackOptions").StatsOptions;
export type Configuration = import("../declarations/WebpackOptions").WebpackOptions;
export type WebpackOptionsNormalized = import("../declarations/WebpackOptions").WebpackOptionsNormalized;
export type WebpackPluginFunction = import("../declarations/WebpackOptions").WebpackPluginFunction;
export type WebpackPluginInstance = import("../declarations/WebpackOptions").WebpackPluginInstance;
