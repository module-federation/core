declare namespace _exports {
    export { Entry, EntryNormalized, EntryObject, ExternalItem, ExternalItemFunction, ExternalItemObjectKnown, ExternalItemObjectUnknown, ExternalItemValue, Externals, FileCacheOptions, GeneratorOptionsByModuleTypeKnown, LibraryOptions, MemoryCacheOptions, ModuleOptions, ParserOptionsByModuleTypeKnown, ResolveOptions, RuleSetCondition, RuleSetConditionAbsolute, RuleSetRule, RuleSetUse, RuleSetUseFunction, RuleSetUseItem, StatsOptions, Configuration, WebpackOptionsNormalized, WebpackPluginFunction, WebpackPluginInstance, ChunkGroup, AssetEmittedInfo, Asset, AssetInfo, EntryOptions, PathData, CodeGenerationResults, Entrypoint, ExternalItemFunctionCallback, ExternalItemFunctionData, ExternalItemFunctionDataGetResolve, ExternalItemFunctionDataGetResolveCallbackResult, ExternalItemFunctionDataGetResolveResult, ExternalItemFunctionPromise, MultiCompilerOptions, MultiConfiguration, MultiStats, MultiStatsOptions, ResolveData, ParserState, ResolvePluginInstance, Resolver, RenderManifestEntry, RenderManifestOptions, TemplatePath, Watching, Argument, Problem, Colors, ColorsOptions, StatsAsset, StatsChunk, StatsChunkGroup, StatsChunkOrigin, StatsCompilation, StatsError, StatsLogging, StatsLoggingEntry, StatsModule, StatsModuleIssuer, StatsModuleReason, StatsModuleTraceDependency, StatsModuleTraceItem, StatsProfile, ObjectSerializerContext, ObjectDeserializerContext, InputFileSystem, OutputFileSystem };
}
declare const _exports: {
     ...
     */
    (options: import("./webpack").WebpackOptions, callback: import("./webpack").Callback<import("./webpack").Stats>): import("./Compiler") | null;
    /**
     * @overload
     * @param {WebpackOptions} options options object
    ...
    config: {
        readonly getNormalizedWebpackOptions: (config: WebpackOptions) => import("./config/normalization").WebpackOptionsNormalized;
        readonly applyWebpackOptionsDefaults: (options: import("./config/defaults").WebpackOptionsNormalized, compilerIndex?: number | undefined) => ResolvedOptions;
    };
    dependencies: {
    ...
    util: {
        ...
        readonly serialization: {
            ...
            createFileSerializer: <D, S, C>(fs: IntermediateFileSystem, hashFunction: string | Hash) => Serializer<D, S, C>;
        };
...
type ExternalItemFunction = import("../declarations/WebpackOptions").ExternalItemFunction;
type ExternalItemObjectKnown = import("../declarations/WebpackOptions").ExternalItemObjectKnown;
type ExternalItemObjectUnknown = import("../declarations/WebpackOptions").ExternalItemObjectUnknown;
type ExternalItemValue = import("../declarations/WebpackOptions").ExternalItemValue;
type Externals = import("../declarations/WebpackOptions").Externals;
type FileCacheOptions = import("../declarations/WebpackOptions").FileCacheOptions;
type GeneratorOptionsByModuleTypeKnown = import("../declarations/WebpackOptions").GeneratorOptionsByModuleTypeKnown;
type LibraryOptions = import("../declarations/WebpackOptions").LibraryOptions;
type MemoryCacheOptions = import("../declarations/WebpackOptions").MemoryCacheOptions;
type ModuleOptions = import("../declarations/WebpackOptions").ModuleOptions;
type ParserOptionsByModuleTypeKnown = import("../declarations/WebpackOptions").ParserOptionsByModuleTypeKnown;
type ResolveOptions = import("../declarations/WebpackOptions").ResolveOptions;
type RuleSetCondition = import("../declarations/WebpackOptions").RuleSetCondition;
type RuleSetConditionAbsolute = import("../declarations/WebpackOptions").RuleSetConditionAbsolute;
...
type RuleSetUseFunction = import("../declarations/WebpackOptions").RuleSetUseFunction;
...
type WebpackOptionsNormalized = import("../declarations/WebpackOptions").WebpackOptionsNormalized;
...
type ExternalItemFunctionCallback = import("./ExternalModuleFactoryPlugin").ExternalItemFunctionCallback;
type ExternalItemFunctionData = import("./ExternalModuleFactoryPlugin").ExternalItemFunctionData;
type ExternalItemFunctionDataGetResolve = import("./ExternalModuleFactoryPlugin").ExternalItemFunctionDataGetResolve;
type ExternalItemFunctionDataGetResolveCallbackResult = import("./ExternalModuleFactoryPlugin").ExternalItemFunctionDataGetResolveCallbackResult;
type ExternalItemFunctionDataGetResolveResult = import("./ExternalModuleFactoryPlugin").ExternalItemFunctionDataGetResolveResult;
type ExternalItemFunctionPromise = import("./ExternalModuleFactoryPlugin").ExternalItemFunctionPromise;
...
type StatsChunkGroup = import("./stats/DefaultStatsFactoryPlugin").StatsChunkGroup;
type StatsChunkOrigin = import("./stats/DefaultStatsFactoryPlugin").StatsChunkOrigin;
...
type StatsLoggingEntry = import("./stats/DefaultStatsFactoryPlugin").StatsLoggingEntry;
type StatsModule = import("./stats/DefaultStatsFactoryPlugin").StatsModule;
type StatsModuleIssuer = import("./stats/DefaultStatsFactoryPlugin").StatsModuleIssuer;
type StatsModuleReason = import("./stats/DefaultStatsFactoryPlugin").StatsModuleReason;
type StatsModuleTraceDependency = import("./stats/DefaultStatsFactoryPlugin").StatsModuleTraceDependency;
type StatsModuleTraceItem = import("./stats/DefaultStatsFactoryPlugin").StatsModuleTraceItem;
