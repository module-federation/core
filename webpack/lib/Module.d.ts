...
declare class Module extends DependenciesBlock {
     ...
     */
    getExportsType(moduleGraph: ModuleGraph, strict: boolean | undefined): ExportsType;
    /**
     ...
     * @returns {void}
     */
    build(options: WebpackOptions, compilation: Compilation, resolver: ResolverWithOptions, fs: InputFileSystem, callback: BuildCallback): void;
    /**
     * @abstract
     ...
     */
    source(dependencyTemplates: DependencyTemplates, runtimeTemplate: RuntimeTemplate, type?: SourceType | undefined): Source;
    /**
     * @abstract
     ...
     */
    _restoreFromUnsafeCache(unsafeCacheData: UnsafeCacheData, normalModuleFactory: NormalModuleFactory): void;
    /**
     ...
     */
    addCacheDependencies(fileDependencies: FileSystemDependencies, contextDependencies: FileSystemDependencies, missingDependencies: FileSystemDependencies, buildDependencies: FileSystemDependencies): void;
...
declare namespace Module {
    export { Source, ResolveOptions, WebpackOptions, Chunk, ModuleId, ChunkGroup, CodeGenerationResults, Compilation, AssetInfo, FileSystemDependencies, UnsafeCacheData, ConcatenationScope, Dependency, UpdateHashContext, CssData, DependencyTemplates, AllTypes, FileSystemInfo, Snapshot, ConnectionState, ModuleTypes, OptimizationBailouts, NormalModuleFactory, RequestShortener, ResolverWithOptions, RuntimeTemplate, CssParserExportType, InitFragment, WebpackError, JsonData, ObjectDeserializerContext, ObjectSerializerContext, Hash, InputFileSystem, AssociatedObjectForCache, RuntimeSpec, ExportsType, LazySet, SourceContext, KnownSourceType, SourceType, SourceTypes, CodeGenerationContext, ConcatenationBailoutReasonContext, RuntimeRequirements, ReadOnlyRuntimeRequirements, KnownCodeGenerationResultDataForJavascriptModules, KnownCodeGenerationResultDataForCssModules, KnownCodeGenerationResultDataForAssetModules, KnownCodeGenerationResultForSharing, CodeGenerationResultData, CodeGenerationResult, LibIdentOptions, KnownBuildMeta, KnownBuildInfo, ValueCacheVersion, ValueCacheVersions, NeedBuildContext, NeedBuildCallback, BuildCallback, BuildMeta, BuildInfo, FactoryMeta, LibIdent, NameForCondition, OptimizationBailoutFunction };
}
...
type ExportsType = "namespace" | "default-only" | "default-with-named" | "dynamic";
/**
 * <T>
 */
...
type KnownCodeGenerationResultDataForJavascriptModules = Map<"topLevelDeclarations", Set<string>> & Map<"chunkInitFragments", InitFragment<EXPECTED_ANY>[]>;
type KnownCodeGenerationResultDataForCssModules = Map<"url", {
    ["css-url"]: string;
}>;
type KnownCodeGenerationResultDataForAssetModules = Map<"filename", string> & Map<"assetInfo", AssetInfo> & Map<"fullContentHash", string>;
type KnownCodeGenerationResultForSharing = Map<"share-init", [{
    shareScope: string;
    initStage: number;
    init: string;
}]>;
type CodeGenerationResultData = KnownCodeGenerationResultDataForJavascriptModules & KnownCodeGenerationResultDataForCssModules & KnownCodeGenerationResultDataForAssetModules & KnownCodeGenerationResultForSharing & Map<string, EXPECTED_ANY>;
...
type KnownBuildMeta = {
    ...
    exportsFinalNameByRuntime?: Map<RuntimeSpec, Record<string, string>> | undefined;
...
type NeedBuildCallback = (err?: WebpackError | null, needBuild?: boolean) => void;
