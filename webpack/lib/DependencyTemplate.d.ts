...
declare namespace DependencyTemplate {
    export { ReplaceSource, ChunkGraph, CodeGenerationResults, ConcatenationScope, Dependency, RuntimeSpec, DependencyTemplates, GenerateContext, Module, RuntimeRequirements, ModuleGraph, RuntimeTemplate, InitFragment, DependencyTemplateContext, CssDependencyTemplateContextExtras, CssData, CssDependencyTemplateContext };
}
