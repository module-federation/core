...
declare class Dependency {
     ...
     */
    getReferencedExports(moduleGraph: ModuleGraph, runtime: RuntimeSpec): ReferencedExports;
    /**
     * @param {ModuleGraph} moduleGraph module graph
...
declare namespace Dependency {
    export { NO_EXPORTS_REFERENCED, EXPORTS_OBJECT_REFERENCED, isLowPriorityDependency, TRANSITIVE, ChunkGraph, DependenciesBlock, Module, ModuleGraph, ModuleGraphConnection, ConnectionState, RuntimeTemplate, WebpackError, ObjectDeserializerContext, ObjectSerializerContext, Hash, RuntimeSpec, ModuleDependency, UpdateHashContext, SourcePosition, RealDependencyLocation, SyntheticDependencyLocation, DependencyLocation, ExportSpec, ExportsSpecExcludeExports, ExportsSpec, ReferencedExport, RawReferencedExports, ReferencedExports, GetConditionFn };
}
...
type GetConditionFn = (moduleGraphConnection: ModuleGraphConnection, runtime: RuntimeSpec) => ConnectionState;
