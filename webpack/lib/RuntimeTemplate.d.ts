...
declare class RuntimeTemplate {
     ...
     */
    moduleNamespacePromise({ chunkGraph, block, module, request, message, strict, weak, dependency, runtimeRequirements }: {
        chunkGraph: ChunkGraph;
     ...
     */
    importStatement({ update, module, moduleGraph, chunkGraph, request, importVar, originModule, weak, dependency, runtimeRequirements }: {
     ...
     * @returns {string} expression
     */
    exportFromImport<GenerateContext>({ moduleGraph, chunkGraph, module, request, exportName, originModule, asiSafe, isCall, callContext, defaultInterop, importVar, initFragments, runtime, runtimeRequirements, dependency }: {
        moduleGraph: ModuleGraph;
        chunkGraph: ChunkGraph;
        module: Module;
        request: string;
...
declare namespace RuntimeTemplate {
    export { OutputOptions, AsyncDependenciesBlock, Chunk, ChunkGraph, Compilation, Dependency, Module, BuildMeta, RuntimeRequirements, ModuleGraph, RequestShortener, RuntimeSpec, ImportPhaseType, ModuleDependency };
}
