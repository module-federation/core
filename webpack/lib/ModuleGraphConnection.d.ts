...
declare class ModuleGraphConnection {
     ...
     */
    constructor(originModule: Module | null, dependency: Dependency | null, module: Module, explanation?: string | undefined, weak?: boolean | undefined, condition?: false | null | GetConditionFn | undefined);
...
declare namespace ModuleGraphConnection {
    export { CIRCULAR_CONNECTION, TRANSITIVE_ONLY, addConnectionStates, Dependency, GetConditionFn, Module, RuntimeSpec, ConnectionState };
}
