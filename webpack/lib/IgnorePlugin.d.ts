...
declare class IgnorePlugin {
     ...
     */
    checkIgnore(resolveData: ResolveData | BeforeContextResolveData): false | undefined;
    /**
     * Apply the plugin
...
declare namespace IgnorePlugin {
    export { IgnorePluginOptions, Compiler, ResolveData, BeforeContextResolveData, CheckResourceFn };
}
type IgnorePluginOptions = import("../declarations/plugins/IgnorePlugin").IgnorePluginOptions;
