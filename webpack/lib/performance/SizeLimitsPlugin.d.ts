...
declare class SizeLimitsPlugin {
    ...
    assetFilter: (name: import("../Compilation").Asset["name"], source: import("../Compilation").Asset["source"], assetInfo: import("../Compilation").Asset["info"]) => boolean;
    /**
     * Apply the plugin
...
declare namespace SizeLimitsPlugin {
    export { Source, PerformanceOptions, ChunkGroup, Asset, Compiler, Entrypoint, WebpackError, AssetDetails, EntrypointDetails };
}
type Source = import("webpack-sources").Source;
type PerformanceOptions = import("../../declarations/WebpackOptions").PerformanceOptions;
