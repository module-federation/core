...
declare class ExportsInfo {
     ...
     */
    getReadOnlyExportInfoRecursive(name: ExportInfoName[]): ExportInfo | undefined;
    /**
     * @param {ExportInfoName[]=} name the export name
     * @returns {ExportsInfo | undefined} the nested exports info
     */
    getNestedExportsInfo(name?: ExportInfoName[] | undefined): ExportsInfo | undefined;
    /**
     ...
     */
    setUnknownExportsProvided(canMangle?: boolean | undefined, excludeExports?: ExportsSpecExcludeExports | undefined, targetKey?: Dependency | undefined, targetModule?: ModuleGraphConnection | undefined, priority?: number | undefined): boolean;
    /**
     ...
     */
    getUsedExports(runtime: RuntimeSpec): SortableSet<ExportInfoName> | boolean | null;
    /**
     ...
     */
    isExportProvided(name: ExportInfoName | ExportInfoName[]): boolean | undefined | null;
    /**
     ...
     */
    getUsed(name: ExportInfoName | ExportInfoName[], runtime: RuntimeSpec): UsageStateType;
    /**
     * @param {ExportInfoName | ExportInfoName[]} name the export name
     * @param {RuntimeSpec} runtime check usage for this runtime only
     * @returns {UsedName} the used name
     */
    getUsedName(name: ExportInfoName | ExportInfoName[], runtime: RuntimeSpec): UsedName;
    /**
     ...
     */
    restoreProvided({ otherProvided, otherCanMangleProvide, otherTerminalBinding, exports }: RestoreProvidedData): void;
}
declare namespace ExportsInfo {
    export { ExportInfo, RestoreProvidedData, UsageState, Dependency, RuntimeSpec, ExportsSpecExcludeExports, HarmonyImportDependency, Module, ModuleGraph, ModuleGraphConnection, ObjectDeserializerContext, ObjectSerializerContext, Hash, RuntimeUsageStateType, UsageStateType, ExportInfoName, UsedInRuntime, TargetItemWithoutConnection, TargetItemWithConnection, ResolveTargetFilter, ValidTargetModuleFilter, TargetItem, Target, ExportInfoUsedName, ExportInfoProvided, Exports, UsedName, AlreadyVisitedExportInfo, RestoreProvidedDataExports };
}
declare class ExportInfo {
     ...
     */
    setUsedConditionally(condition: (condition: UsageStateType) => boolean, newValue: UsageStateType, runtime: RuntimeSpec): boolean;
    /**
     ...
     * @returns {boolean} true, if something has changed
     */
    setTarget(key: Dependency, connection: ModuleGraphConnection, exportName?: (ExportInfoName[] | null) | undefined, priority?: number | undefined): boolean;
    /**
     ...
     */
    getTerminalBinding(moduleGraph: ModuleGraph, resolveTargetFilter?: ResolveTargetFilter): ExportInfo | ExportsInfo | undefined;
    isReexport(): boolean;
     ...
     */
    findTarget(moduleGraph: ModuleGraph, validTargetModuleFilter: ValidTargetModuleFilter): TargetItemWithoutConnection | null | undefined | false;
    /**
     * @param {ModuleGraph} moduleGraph the module graph
     * @param {ValidTargetModuleFilter} validTargetModuleFilter a valid target module
     ...
     * @returns {TargetItemWithoutConnection | null | undefined | false} the target, undefined when there is no target, false when no target is valid
     */
    _findTarget(moduleGraph: ModuleGraph, validTargetModuleFilter: ValidTargetModuleFilter, alreadyVisited: AlreadyVisitedExportInfo): TargetItemWithoutConnection | null | undefined | false;
    /**
     * @param {ModuleGraph} moduleGraph the module graph
     * @param {ResolveTargetFilter} resolveTargetFilter filter function to further resolve target
     * @returns {TargetItemWithConnection | undefined} the target
     */
    getTarget(moduleGraph: ModuleGraph, resolveTargetFilter?: ResolveTargetFilter): TargetItemWithConnection | undefined;
    /**
     * @param {ModuleGraph} moduleGraph the module graph
     * @param {ResolveTargetFilter} resolveTargetFilter filter function to further resolve target
     ...
     */
    _getTarget(moduleGraph: ModuleGraph, resolveTargetFilter: ResolveTargetFilter, alreadyVisited: AlreadyVisitedExportInfo | undefined): TargetItemWithConnection | typeof CIRCULAR | undefined;
    /**
     ...
     */
    moveTarget(moduleGraph: ModuleGraph, resolveTargetFilter: ResolveTargetFilter, updateOriginalConnection?: ((target: TargetItemWithConnection) => ModuleGraphConnection) | undefined): TargetItemWithConnection | undefined;
    /**
...
declare class RestoreProvidedData {
     ...
     */
    constructor(exports: RestoreProvidedDataExports[], otherProvided: ExportInfo["provided"], otherCanMangleProvide: ExportInfo["canMangleProvide"], otherTerminalBinding: ExportInfo["terminalBinding"]);
...
type ExportsSpecExcludeExports = import("./Dependency").ExportsSpecExcludeExports;
