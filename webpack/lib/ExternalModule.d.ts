...
declare class ExternalModule extends Module {
     ...
     */
    constructor(request: ExternalModuleRequest, type: ExternalsType, userRequest: string, dependencyMeta?: DependencyMeta | undefined);
...
declare namespace ExternalModule {
    export { ModuleExternalInitFragment, getExternalModuleNodeCommonjsInitFragment, Source, ExternalsType, HashFunction, WebpackOptions, Chunk, ChunkGraph, Compilation, UnsafeCacheData, UpdateHashContext, ExportsInfo, GenerateContext, SourceTypes, ModuleId, BuildCallback, BuildInfo, CodeGenerationContext, CodeGenerationResult, ConcatenationBailoutReasonContext, LibIdentOptions, LibIdent, NeedBuildCallback, NeedBuildContext, ReadOnlyRuntimeRequirements, ModuleGraph, NormalModuleFactory, RequestShortener, ResolverWithOptions, RuntimeTemplate, ChunkRenderContext, ImportAttributes, ObjectDeserializerContext, ObjectSerializerContext, Hash, InputFileSystem, RuntimeSpec, ImportDependencyMeta, CssImportDependencyMeta, AssetDependencyMeta, DependencyMeta, SourceData, Imported, ModuleAndSpecifiers, RequestRecord, ExternalModuleRequest };
}
import Module = require("./Module");
/**
 * @extends {InitFragment<GenerateContext>}
 */
declare class ModuleExternalInitFragment extends InitFragment<import("./Generator").GenerateContext> {
    /**
     ...
     */
    constructor(request: string, imported: Imported, ident?: string | undefined, dependencyMeta?: ImportDependencyMeta | undefined, hashFunction?: HashFunction | undefined);
    _ident: string;
    _request: string;
 ...
 */
declare function getExternalModuleNodeCommonjsInitFragment(runtimeTemplate: RuntimeTemplate): InitFragment<ChunkRenderContext>;
...
type DependencyMeta = ImportDependencyMeta | CssImportDependencyMeta | AssetDependencyMeta;
type SourceData = {
