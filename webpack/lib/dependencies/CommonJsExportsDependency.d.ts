...
declare class CommonJsExportsDependency extends NullDependency {
     ...
     */
    constructor(range: Range, valueRange: Range | null, base: CommonJSDependencyBaseKeywords, names: ExportInfoName[]);
...
declare namespace CommonJsExportsDependency {
    export { CommonJsExportsDependencyTemplate as Template, ReplaceSource, Dependency, ExportsSpec, DependencyTemplateContext, ModuleGraph, ExportInfoName, Range, ObjectDeserializerContext, ObjectSerializerContext, CommonJSDependencyBaseKeywords };
}
