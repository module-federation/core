...
declare class CommonJsExportsDependency extends NullDependency {
     ...
     */
    constructor(range: import("../javascript/JavascriptParser").Range, valueRange: import("../javascript/JavascriptParser").Range, base: CommonJSDependencyBaseKeywords, names: string[]);
