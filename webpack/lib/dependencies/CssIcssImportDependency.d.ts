...
declare class CssIcssImportDependency extends CssImportDependency {
     ...
     */
    constructor(request: string, range: Range, mode: "local" | "global", name: string, exportName?: string | undefined, exportMode?: ExportMode | undefined, exportType?: ExportType | undefined);
    name: string;
    value: string;
    interpolate: boolean;
...
declare namespace CssIcssImportDependency {
    export { CssIcssImportDependencyTemplate as Template, ReplaceSource, Dependency, DependencyTemplateContext, Module, CssModule, ModuleGraph, RuntimeSpec, Range, ObjectDeserializerContext, ObjectSerializerContext, ReferencedExports, CssGeneratorExportsConvention, ExportMode, ExportType };
}
import CssImportDependency = require("./CssImportDependency");
declare const CssIcssImportDependencyTemplate_base: {
    new (): {
        apply(dependency: CssImportDependency.Dependency, source: CssImportDependency.ReplaceSource, templateContext: CssImportDependency.DependencyTemplateContext): void;
    };
};
