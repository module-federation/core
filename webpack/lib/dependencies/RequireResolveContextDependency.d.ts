...
declare class RequireResolveContextDependency extends ContextDependency {
     ...
     */
    constructor(options: ContextDependencyOptions, range: import("../javascript/JavascriptParser").Range, valueRange: import("../javascript/JavascriptParser").Range, context: TODO);
