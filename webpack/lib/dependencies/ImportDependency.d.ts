...
declare class ImportDependency extends ModuleDependency {
     ...
     */
    constructor(request: string, range: Range, referencedExports: RawReferencedExports | null, phase: ImportPhaseType, attributes?: ImportAttributes | undefined);
...
declare namespace ImportDependency {
    export { ImportDependencyTemplate as Template, ReplaceSource, AsyncDependenciesBlock, RawReferencedExports, ReferencedExports, DependencyTemplateContext, Module, BuildMeta, ModuleGraph, ImportAttributes, Range, ObjectDeserializerContext, ObjectSerializerContext, RuntimeSpec, ImportPhaseType };
}
