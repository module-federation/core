...
declare class HarmonyAcceptDependency extends NullDependency {
     ...
     */
    constructor(range: Range, dependencies: HarmonyAcceptImportDependency[], hasCallback: boolean);
    range: import("../javascript/JavascriptParser").Range;
    dependencies: import("./HarmonyAcceptImportDependency")[];
    hasCallback: boolean;
}
declare namespace HarmonyAcceptDependency {
    export { HarmonyAcceptDependencyTemplate as Template, ReplaceSource, Dependency, DependencyTemplateContext, Range, ObjectDeserializerContext, ObjectSerializerContext, HarmonyAcceptImportDependency, Module, ModuleId };
}
