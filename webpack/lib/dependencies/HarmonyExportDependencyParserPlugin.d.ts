...
declare class HarmonyExportDependencyParserPlugin {
     ...
     */
    constructor(options: import("../../declarations/WebpackOptions").JavascriptParserOptions);
...
declare namespace HarmonyExportDependencyParserPlugin {
    export { DependencyLocation, JavascriptParser, ClassDeclaration, FunctionDeclaration, Range, HarmonySettings, CompatibilitySettings };
}
type DependencyLocation = import("../Dependency").DependencyLocation;
type JavascriptParser = import("../javascript/JavascriptParser");
type ClassDeclaration = import("../javascript/JavascriptParser").ClassDeclaration;
type FunctionDeclaration = import("../javascript/JavascriptParser").FunctionDeclaration;
