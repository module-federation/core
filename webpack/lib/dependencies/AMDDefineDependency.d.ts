...
declare class AMDDefineDependency extends NullDependency {
     ...
     */
    constructor(range: import("../javascript/JavascriptParser").Range, arrayRange: import("../javascript/JavascriptParser").Range, functionRange: import("../javascript/JavascriptParser").Range, objectRange: import("../javascript/JavascriptParser").Range, namedModule: boolean);
...
declare class AMDDefineDependencyTemplate extends AMDDefineDependencyTemplate_base {
     ...
     */
    replace(dependency: AMDDefineDependency, source: any, definition: string, text: string): void;
}
