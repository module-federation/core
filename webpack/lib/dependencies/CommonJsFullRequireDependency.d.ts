...
declare class CommonJsFullRequireDependency extends ModuleDependency {
     ...
     */
    constructor(request: string, range: Range, names: ExportInfoName[], idRanges?: IdRanges | undefined);
    names: string[];
...
declare namespace CommonJsFullRequireDependency {
    export { CommonJsFullRequireDependencyTemplate as Template, ReplaceSource, Dependency, ReferencedExports, DependencyTemplateContext, ModuleGraph, Range, ExportInfoName, ObjectDeserializerContext, ObjectSerializerContext, RuntimeSpec, IdRanges };
}
