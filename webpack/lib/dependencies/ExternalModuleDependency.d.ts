...
declare class ExternalModuleDependency extends CachedConstDependency {
     ...
     */
    constructor(module: string, importSpecifiers: ArrayImportSpecifiers, defaultImport: string | undefined, expression: string, range: Range | null, identifier: string, place?: number | undefined);
    importedModule: string;
    specifiers: ExternalModuleInitFragment.ArrayImportSpecifiers;
    default: string;
}
declare namespace ExternalModuleDependency {
    export { ExternalModuleDependencyTemplate as Template, ReplaceSource, Dependency, DependencyTemplateContext, Range, ArrayImportSpecifiers, ObjectDeserializerContext, ObjectSerializerContext };
}
...
declare const ExternalModuleDependencyTemplate_base: {
    new (): {
        apply(dependency: CachedConstDependency.Dependency, source: CachedConstDependency.ReplaceSource, { initFragments, chunkInitFragments }: CachedConstDependency.DependencyTemplateContext): void;
    };
};
