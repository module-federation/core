...
declare const HarmonyEvaluatedImportSpecifierDependencyTemplate_base: {
  new (): {
    apply(
      ...
      source: HarmonyImportSpecifierDependency.ReplaceSource,
      templateContext: HarmonyImportSpecifierDependency.DependencyTemplateContext,
    ): void;
    _getCodeForIds(
      dep: HarmonyImportSpecifierDependency,
      source: HarmonyImportSpecifierDependency.ReplaceSource,
      templateContext: HarmonyImportSpecifierDependency.DependencyTemplateContext,
      ids: HarmonyImportSpecifierDependency.Ids,
    ): string;
  };
