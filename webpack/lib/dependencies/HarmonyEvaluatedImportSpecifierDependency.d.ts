...
declare class HarmonyEvaluatedImportSpecifierDependency extends HarmonyImportSpecifierDependency {
     ...
     */
    constructor(request: string, sourceOrder: number, ids: TODO, name: TODO, range: import("../javascript/JavascriptParser").Range, assertions: Assertions, operator: string);
    operator: string;
}
...
declare const HarmonyEvaluatedImportSpecifierDependencyTemplate_base: {
    new (): {
        apply(dependency: import("../Dependency"), source: any, templateContext: import("../DependencyTemplate").DependencyTemplateContext): void;
        _trimIdsToThoseImported(ids: string[], moduleGraph: import("../ModuleGraph"), dependency: HarmonyImportSpecifierDependency): string[];
        _getCodeForIds(dep: HarmonyImportSpecifierDependency, source: any, templateContext: import("../DependencyTemplate").DependencyTemplateContext, ids: string[]): string;
    };
    getImportEmittedRuntime(module: import("../Module"), referencedModule: import("../Module")): boolean | import("../util/runtime").RuntimeSpec;
};
