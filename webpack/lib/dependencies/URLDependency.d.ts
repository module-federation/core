...
declare class URLDependency extends ModuleDependency {
     ...
     */
    constructor(request: string, range: import("../javascript/JavascriptParser").Range, outerRange: import("../javascript/JavascriptParser").Range, relative?: boolean | undefined);
