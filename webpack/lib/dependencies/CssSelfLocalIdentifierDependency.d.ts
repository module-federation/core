...
declare class CssSelfLocalIdentifierDependency extends CssLocalIdentifierDependency {
     ...
     */
    constructor(name: string, range: import("../css/CssParser").Range, prefix?: string | undefined, declaredSet?: Set<string> | undefined);
...
declare const CssSelfLocalIdentifierDependencyTemplate_base: {
    new (): {
        apply(dependency: Dependency, source: any, { module, moduleGraph, chunkGraph, runtime, runtimeTemplate, cssExports }: import("../DependencyTemplate").CssDependencyTemplateContext): void;
    };
};
