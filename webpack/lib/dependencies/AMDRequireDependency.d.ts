...
declare class AMDRequireDependency extends NullDependency {
     ...
     */
    constructor(outerRange: import("../javascript/JavascriptParser").Range, arrayRange: import("../javascript/JavascriptParser").Range, functionRange: import("../javascript/JavascriptParser").Range, errorCallbackRange: import("../javascript/JavascriptParser").Range);
