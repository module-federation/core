export function create(Dep: ContextDependencyConstructor, range: import("../javascript/JavascriptParser").Range, param: BasicEvaluatedExpression, expr: EsTreeNode, options: Pick<JavascriptParserOptions, `${"expr" | "wrapped"}Context${"Critical" | "Recursive" | "RegExp"}` | "exprContextRequest">, contextOptions: PartialContextDependencyOptions, parser: JavascriptParser, ...depArgs: any[]): ContextDependency;
...
export type ContextDependencyConstructor = new (options: ContextDependencyOptions, range: import("../javascript/JavascriptParser").Range, valueRange: [number, number], ...args: any[]) => ContextDependency;
