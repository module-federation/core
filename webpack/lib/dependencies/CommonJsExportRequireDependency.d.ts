...
declare class CommonJsExportRequireDependency extends ModuleDependency {
     ...
     */
    constructor(range: import("../javascript/JavascriptParser").Range, valueRange: import("../javascript/JavascriptParser").Range, base: CommonJSDependencyBaseKeywords, names: string[], request: string, ids: string[], resultUsed: boolean);
