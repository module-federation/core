...
declare class RequireEnsureDependency extends NullDependency {
     ...
     */
    constructor(range: import("../javascript/JavascriptParser").Range, contentRange: import("../javascript/JavascriptParser").Range, errorHandlerRange: import("../javascript/JavascriptParser").Range);
