...
declare class HarmonyExportImportedSpecifierDependency extends HarmonyImportDependency {
  ...
  constructor(
    ...
    otherStarExports: ReadonlyArray<HarmonyExportImportedSpecifierDependency> | null,
   ...
   */
  _getEffectiveExportPresenceLevel(
    moduleGraph: ModuleGraph,
  ): ExportPresenceMode;
  /**
   * @param {ModuleGraph} moduleGraph module graph
...
declare const HarmonyExportImportedSpecifierDependencyTemplate_base: {
  ...
  ): HarmonyImportDependency.RuntimeSpec | boolean;
};
declare class HarmonyExportImportedSpecifierDependencyTemplate extends HarmonyExportImportedSpecifierDependencyTemplate_base {
  ...
  getReexportFakeNamespaceObjectFragments(
    ...
    fakeType: number,
    runtimeRequirements: RuntimeRequirements,
  ): [InitFragment<GenerateContext>, HarmonyExportInitFragment];
  /**
   * @param {Module} module module
  ...
  getReturnValue(
    name: string,
    valueKey: null | false | string | string[],
  ): string | undefined;
}
...
type ExportPresenceMode =
  import('./HarmonyImportDependency').ExportPresenceMode;
