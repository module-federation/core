...
declare namespace JsonExportsDependency {
    export { ExportSpec, ExportsSpec, UpdateHashContext, ModuleGraph, JsonData, JsonValue, ObjectDeserializerContext, ObjectSerializerContext, Hash, GetExportsFromDataFn };
}
...
type GetExportsFromDataFn = (data: JsonValue, curDepth?: number | undefined) => ExportSpec[] | null;
