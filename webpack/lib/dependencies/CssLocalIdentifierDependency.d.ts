...
declare class CssLocalIdentifierDependency extends NullDependency {
     ...
     */
    constructor(name: string, range: import("../css/CssParser").Range, prefix?: string | undefined);
    name: string;
...
declare class CssLocalIdentifierDependencyTemplate extends CssLocalIdentifierDependencyTemplate_base {
     ...
     * @returns {void}
     */
    apply(dependency: Dependency, source: any, { module, moduleGraph, chunkGraph, runtime, runtimeTemplate, cssExports }: DependencyTemplateContext): void;
}
