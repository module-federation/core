...
declare class ProvidedDependency extends ModuleDependency {
     ...
     */
    constructor(request: string, identifier: string, ids: ExportInfoName[], range: Range);
    identifier: string;
    ids: string[];
    _hashUpdate: string;
}
declare namespace ProvidedDependency {
    export { ProvidedDependencyTemplate as Template, ReplaceSource, ReferencedExports, UpdateHashContext, DependencyTemplateContext, ModuleGraph, ModuleGraphConnection, ExportInfoName, Range, ObjectDeserializerContext, ObjectSerializerContext, Hash, RuntimeSpec };
}
