...
declare class CommonJsRequireContextDependency extends ContextDependency {
     ...
     */
    constructor(options: TODO, range: import("../javascript/JavascriptParser").Range, valueRange: import("../javascript/JavascriptParser").Range | undefined, inShorthand: boolean | string, context: string);
