...
declare class CachedConstDependency extends NullDependency {
     ...
     */
    constructor(expression: string, range: Range | null, identifier: string, place?: number | undefined);
    expression: string;
...
declare namespace CachedConstDependency {
    export { PLACE_MODULE, PLACE_CHUNK, CachedConstDependencyTemplate as Template, ReplaceSource, Dependency, UpdateHashContext, DependencyTemplateContext, Range, ObjectDeserializerContext, ObjectSerializerContext, Hash };
}
