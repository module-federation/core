...
declare class CssIcssExportDependency extends NullDependency {
     ...
     */
    constructor(name: string, value: string | [string, string, boolean], range?: Range | undefined, interpolate?: boolean | undefined, exportMode?: ExportMode | undefined, exportType?: ExportType | undefined);
    name: string;
     ...
     */
    getExportsConventionNames(name: string, convention: CssGeneratorExportsConvention): string[];
    _conventionNames: string[];
}
declare namespace CssIcssExportDependency {
    export { CssIcssExportDependencyTemplate as Template, EXPORT_MODE, EXPORT_TYPE, ReplaceSource, CssGeneratorExportsConvention, CssGeneratorLocalIdentName, CssModule, Dependency, ReferencedExports, ExportsSpec, UpdateHashContext, DependencyTemplateContext, ModuleGraph, CssGenerator, ObjectDeserializerContext, ObjectSerializerContext, Hash, RuntimeSpec, ChunkGraph, RuntimeTemplate, Range, ExportMode, ExportType };
}
...
declare class CssIcssExportDependencyTemplate extends CssIcssExportDependencyTemplate_base {
     ...
     */
    static findReference(symbol: string, templateContext: DependencyTemplateContext): string | undefined;
    /**
     ...
     */
    static getIdentifier(value: string, dependency: Dependency, templateContext: DependencyTemplateContext): string;
    /**
     * @param {Dependency} dependency the dependency for which the template should be applied
...
declare var EXPORT_MODE: Record<"NONE" | "REPLACE" | "APPEND" | "ONCE" | "SELF_REFERENCE", ExportMode>;
declare var EXPORT_TYPE: Record<"NORMAL" | "CUSTOM_VARIABLE" | "GRID_CUSTOM_IDENTIFIER", ExportType>;
type ReplaceSource = import("webpack-sources").ReplaceSource;
type CssGeneratorExportsConvention = import("../../declarations/WebpackOptions").CssGeneratorExportsConvention;
type CssGeneratorLocalIdentName = import("../../declarations/WebpackOptions").CssGeneratorLocalIdentName;
