...
declare class PureExpressionDependency extends NullDependency {
     ...
     */
    _getRuntimeCondition(moduleGraph: ModuleGraph, runtime: RuntimeSpec): boolean | RuntimeSpec;
}
declare namespace PureExpressionDependency {
    export { PureExpressionDependencyTemplate as Template, ReplaceSource, Dependency, RuntimeSpec, UpdateHashContext, DependencyTemplateContext, Module, ModuleGraph, ConnectionState, Range, ObjectDeserializerContext, ObjectSerializerContext, Hash };
}
