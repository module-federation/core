...
declare namespace ImportEagerDependency {
    export { ImportEagerDependencyTemplate as Template, ReplaceSource, Dependency, DependencyTemplateContext, Module, BuildMeta, ImportAttributes, Range, RawReferencedExports, ImportPhaseType };
}
