...
declare namespace ModuleDecoratorDependency {
    export { ModuleDecoratorDependencyTemplate as Template, ReplaceSource, ReferencedExports, UpdateHashContext, DependencyTemplateContext, ModuleGraph, ObjectDeserializerContext, ObjectSerializerContext, Hash, RuntimeSpec };
}
import NullDependency = require("./NullDependency");
declare const ModuleDecoratorDependencyTemplate_base: {
    new (): {
        apply(dependency: Dependency, source: NullDependency.ReplaceSource, templateContext: NullDependency.DependencyTemplateContext): void;
    };
};
