...
declare class ExportsInfoDependency extends NullDependency {
     ...
     */
    constructor(range: Range, exportName: ExportInfoName[] | null, property: string | null);
    range: import("../javascript/JavascriptParser").Range;
    exportName: string[];
    property: string;
}
declare namespace ExportsInfoDependency {
    export { ExportsInfoDependencyTemplate as Template, ReplaceSource, Dependency, DependencyTemplateContext, Module, ModuleGraph, ExportInfoName, Range, ObjectDeserializerContext, ObjectSerializerContext, RuntimeSpec, SortableSet };
}
