...
declare class HarmonyImportSpecifierDependency extends HarmonyImportDependency {
     ...
     */
    constructor(request: TODO, sourceOrder: number, ids: string[], name: string, range: import("../javascript/JavascriptParser").Range, exportPresenceMode: TODO, assertions?: Assertions | undefined, idRanges?: import("../javascript/JavascriptParser").Range[] | undefined);
    ids: string[];
    name: string;
...
declare const HarmonyImportSpecifierDependencyTemplate_base: {
    new (): {
        apply(dependency: Dependency, source: any, templateContext: import("../DependencyTemplate").DependencyTemplateContext): void;
    };
...
declare class HarmonyImportSpecifierDependencyTemplate extends HarmonyImportSpecifierDependencyTemplate_base {
     ...
     * @returns {string} generated code
     */
    _getCodeForIds(dep: HarmonyImportSpecifierDependency, source: any, templateContext: DependencyTemplateContext, ids: string[]): string;
}
