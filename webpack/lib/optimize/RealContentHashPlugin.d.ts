...
declare namespace RealContentHashPlugin {
    export { HashFunction, HashDigest, Source, Etag, AssetInfo, Compiler, Hash, OwnHashes, ReferencedHashes, Hashes, AssetInfoForRealContentHash, CompilationHooks, RealContentHashPluginOptions };
}
