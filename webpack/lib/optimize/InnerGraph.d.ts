export function addUsage(state: ParserState, symbol: TopLevelSymbol | null, usage: Usage): void;
export function addVariableUsage(parser: JavascriptParser, name: string, usage: Usage): void;
export function bailout(parserState: ParserState): void;
export function enable(parserState: ParserState): void;
export function getDependencyUsedByExportsCondition(dependency: Dependency, usedByExports: UsedByExports | undefined, moduleGraph: ModuleGraph): null | false | GetConditionFn;
...
export function isDependencyUsedByExports(dependency: Dependency, usedByExports: UsedByExports | undefined, moduleGraph: ModuleGraph, runtime: RuntimeSpec): boolean;
