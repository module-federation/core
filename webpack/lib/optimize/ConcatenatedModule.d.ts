...
declare class ConcatenatedModule extends Module {
     ...
     */
    static create(rootModule: Module, modules: Set<Module>, runtime: RuntimeSpec, compilation: Compilation, associatedObjectForCache?: AssociatedObjectForCache | undefined, hashFunction?: (string | HashConstructor) | undefined): ConcatenatedModule;
    /**
     * @param {Compilation} compilation the compilation
     ...
     */
    static _createIdentifier(rootModule: Module, modules: Set<Module>, associatedObjectForCache?: AssociatedObjectForCache | undefined, hashFunction?: (string | HashConstructor) | undefined): string;
    /**
     ...
     */
    _analyseModule(modulesMap: ModuleToInfoMap, info: ModuleInfo, dependencyTemplates: DependencyTemplates, runtimeTemplate: RuntimeTemplate, moduleGraph: ModuleGraph, chunkGraph: ChunkGraph, runtime: RuntimeSpec, runtimes: RuntimeSpec[], codeGenerationResults: CodeGenerationResults, usedNames: Set<string>): void;
    /**
     * @param {ModuleGraph} moduleGraph the module graph
     * @param {RuntimeSpec} runtime the runtime
     * @returns {[ModuleInfoOrReference[], ModuleToInfoMap]} module info items
     */
    _getModulesWithInfo(moduleGraph: ModuleGraph, runtime: RuntimeSpec): [ModuleInfoOrReference[], ModuleToInfoMap];
    /**
...
declare namespace ConcatenatedModule {
    export { Reference, Scope, Variable, Source, WebpackOptions, ChunkGraph, CodeGenerationResults, Compilation, UpdateHashContext, DependencyTemplates, ExportInfo, BuildCallback, BuildInfo, FileSystemDependencies, BuildMeta, CodeGenerationContext, CodeGenerationResult, LibIdentOptions, LibIdent, NameForCondition, ReadOnlyRuntimeRequirements, RuntimeRequirements, SourceTypes, ModuleGraph, ModuleGraphConnection, ConnectionState, RequestShortener, ResolverWithOptions, RuntimeTemplate, ChunkRenderContext, Program, Range, ObjectDeserializerContext, Hash, HashConstructor, ScopeInfo, InputFileSystem, AssociatedObjectForCache, RuntimeSpec, InitFragment, Comparator, Binding, ExportName, RawBinding, SymbolBinding, ModuleInfo, ModuleInfoOrReference, ExportMap, ConcatenatedModuleInfo, ExternalModuleInfo, ReferenceToModuleInfo, NonDeferAccess, ConcatenationEntry, NeededNamespaceObjects, ModuleToInfoMap, ConcatenateModuleHooks, TopLevelDeclarations };
}
...
type ConcatenateModuleHooks = {
    onDemandExportsGeneration: SyncBailHook<[ConcatenatedModule, RuntimeSpec[], string, Record<string, string>], boolean>;
    concatenatedModuleInfo: SyncBailHook<[Partial<ConcatenatedModuleInfo>, ConcatenatedModuleInfo], boolean | void>;
};
