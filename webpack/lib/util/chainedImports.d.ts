export function getTrimmedIdsAndRange(untrimmedIds: string[], untrimmedRange: Range, ranges: IdRanges | undefined, moduleGraph: ModuleGraph, dependency: Dependency): {
    trimmedIds: string[];
    trimmedRange: Range;
};
