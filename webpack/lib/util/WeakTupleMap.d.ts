...
type W<T extends EXPECTED_ANY[], V> = WeakMap<EXPECTED_OBJECT, WeakTupleMap<T, V>>;
type ArrayElement<T extends unknown[]> = T extends ReadonlyArray<infer ElementType> ? ElementType : never;
