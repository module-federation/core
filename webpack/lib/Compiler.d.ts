...
declare class Compiler {
  ...
  hooks: Readonly<{
    ...
    infrastructureLog: SyncBailHook<
      [string, string, EXPECTED_ANY[] | undefined],
      true | void
    >;
    /** @type {SyncHook<[]>} */
  ...
  webpack: {
    ...
    config: {
      readonly getNormalizedWebpackOptions: (
        config: import('./config/normalization').WebpackOptions,
    ...
    util: {
      ...
      readonly serialization: {
        ...
        createFileSerializer: <D, S, C>(
          fs: import('./util/serialization').IntermediateFileSystem,
...
type ChunkModuleHashes =
  import('./HotModuleReplacementPlugin').ChunkModuleHashes;
...
type FullHashChunkModuleHashes =
  import('./HotModuleReplacementPlugin').FullHashChunkModuleHashes;
