...
declare class NodeWatchFileSystem {
    ...
    watch(files: Iterable<string>, directories: Iterable<string>, missing: Iterable<string>, startTime: number, options: import("../util/fs").WatchOptions, callback: (err: Error | null, timeInfoEntries1?: import("../util/fs").TimeInfoEntries, timeInfoEntries2?: import("../util/fs").TimeInfoEntries, changes?: import("../util/fs").Changes, removals?: import("../util/fs").Removals) => void, callbackUndelayed: (value: string, num: number) => void): import("../util/fs").Watcher;
}
