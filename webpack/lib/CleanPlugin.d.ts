...
declare namespace CleanPlugin {
    export { getDirectories as _getDirectories, CurrentAssets, CleanOptions, Compiler, Logger, IStats, OutputFileSystem, StatsCallback, Assets, CleanPluginCompilationHooks, KeepFn, Diff };
}
