...
declare class NormalModule extends Module {
     ...
     */
    createSourceForAsset(context: string, name: string, content: string, sourceMap: string | TODO, associatedObjectForCache?: any | undefined): any;
    /**
     ...
     */
    _createLoaderContext(resolver: ResolverWithOptions, options: WebpackOptions, compilation: Compilation, fs: InputFileSystem, hooks: NormalModuleCompilationHooks): import("../declarations/LoaderContext").NormalModuleLoaderContext<any>;
     ...
     * @returns {Source} the created source
     */
    createSource(context: string, content: string | Buffer, sourceMap: string | TODO, associatedObjectForCache?: any | undefined): any;
    /**
     * @param {WebpackOptions} options webpack options
     * @param {Compilation} compilation the compilation
     ...
     * @returns {void}
     */
    _doBuild(options: WebpackOptions, compilation: Compilation, resolver: ResolverWithOptions, fs: InputFileSystem, hooks: NormalModuleCompilationHooks, callback: (arg0: (WebpackError | null) | undefined) => void): void;
    _ast: any;
    /**
...
type Source = any;
type NormalModuleLoaderContext = import("../declarations/LoaderContext").NormalModuleLoaderContext<any>;
