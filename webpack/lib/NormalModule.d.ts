...
declare class NormalModule extends Module {
     ...
     */
    constructor({ layer, type, request, userRequest, rawRequest, loaders, resource, resourceResolveData, context, matchResource, parser, parserOptions, generator, generatorOptions, resolveOptions, extractSourceMap }: NormalModuleCreateData);
     ...
     */
    restoreFromUnsafeCache(unsafeCacheData: UnsafeCacheData, normalModuleFactory: NormalModuleFactory): void;
    /**
     ...
     */
    createSourceForAsset(context: string, name: string, content: string | Buffer, sourceMap?: (string | RawSourceMap) | undefined, associatedObjectForCache?: AssociatedObjectForCache | undefined): Source;
    /**
     * @private
     * @template T
     ...
     */
    getCurrentLoader(loaderContext: AnyLoaderContext, index?: number): LoaderItem | null;
    /**
     * @param {string} context the compilation context
     * @param {string | Buffer} content the content
     ...
     * @returns {Source} the created source
     */
    createSource(context: string, content: string | Buffer, sourceMap?: (string | RawSourceMap | null) | undefined, associatedObjectForCache?: AssociatedObjectForCache | undefined): Source;
    /**
     * @param {WebpackOptions} options webpack options
     * @param {Compilation} compilation the compilation
     ...
     * @returns {void}
     */
    _doBuild(options: WebpackOptions, compilation: Compilation, resolver: ResolverWithOptions, fs: InputFileSystem, hooks: NormalModuleCompilationHooks, callback: BuildCallback): void;
    _ast: any;
    /**
     ...
     */
    applyNoParseRule(rule: Exclude<NoParse, EXPECTED_ANY[]>, content: string): boolean;
    /**
     ...
     */
    shouldPreventParsing(noParseRule: undefined | NoParse, request: string): boolean;
    /**
...
declare namespace NormalModule {
    export { ResolveContext, ResolveRequest, Source, RawSourceMap, ResolveOptions, NoParse, WebpackOptions, UpdateHashContext, Generator, GenerateErrorFn, BuildInfo, FileSystemDependencies, BuildMeta, CodeGenerationContext, CodeGenerationResult, CodeGenerationResultData, ConcatenationBailoutReasonContext, KnownBuildInfo, LibIdentOptions, LibIdent, NameForCondition, NeedBuildContext, NeedBuildCallback, BuildCallback, RuntimeRequirements, SourceType, SourceTypes, UnsafeCacheData, ModuleGraph, ConnectionState, NormalModuleFactory, NormalModuleTypes, ResourceSchemeData, Parser, PreparsedAst, RequestShortener, ResolverWithOptions, ObjectDeserializerContext, ObjectSerializerContext, Hash, InputFileSystem, HashFunction, AssociatedObjectForCache, FakeHook, ParserOptions, GeneratorOptions, LoaderContext, NormalModuleLoaderContext, LoaderItem, Result, AnyLoaderContext, NormalModuleCompilationHooks, NormalModuleCreateData, ReadResource };
}
...
type LoaderContext<T> = import("../declarations/LoaderContext").LoaderContext<T>;
type NormalModuleLoaderContext<T> = import("../declarations/LoaderContext").NormalModuleLoaderContext<T>;
type LoaderItem = {
    loader: string;
...
type Result = [string | Buffer, string | RawSourceMap | undefined, PreparsedAst | undefined];
...
type NormalModuleCompilationHooks = {
    ...
    readResourceForScheme: HookMap<FakeHook<AsyncSeriesBailHook<[string, NormalModule], string | Buffer | null>>>;
    readResource: HookMap<AsyncSeriesBailHook<[AnyLoaderContext], string | Buffer | null>>;
...
type NormalModuleCreateData = {
     ...
     */
    resourceResolveData?: (ResourceSchemeData & Partial<ResolveRequest>) | undefined;
    /**
...
type ReadResource = (resourcePath: string, getLoaderContext: (resourcePath: string) => AnyLoaderContext) => Promise<string | Buffer<ArrayBufferLike>>;
