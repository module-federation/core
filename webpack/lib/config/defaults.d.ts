...
export type SnapshotNormalizedWithDefaults = SnapshotOptions & {
  ...
  resolveBuildDependencies: NonNullable<
    SnapshotOptions['resolveBuildDependencies']
  >;
...
export type InfrastructureLoggingNormalizedWithDefaults =
...
export type WebpackOptionsNormalizedWithBaseDefaults =
...
export type WebpackOptionsNormalizedWithDefaults =
 ...
 * @returns {void}
 */
export function applyWebpackOptionsBaseDefaults(
 ...
 */
export function applyWebpackOptionsDefaults(
  options: WebpackOptionsNormalized,
