import type { GlobalModuleInfo, ModuleInfo } from '@module-federation/sdk/core';
import type {
  Options,
  PreloadAssets,
  PreloadOptions,
...
export const createRemoteHooks = () =>
  new PluginSystem({
...
export type RemoteHooks = ReturnType<typeof createRemoteHooks>;
