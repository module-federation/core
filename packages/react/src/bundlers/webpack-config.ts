...
import { DefaultContainerName, DefaultRemoteName } from "../utilities/constants";
...
*/
const DefaultConfiguration = ({ scope, scopeType, useTypescript, devPort } : BundlerConfigProps) => {
    return {
        ...
        resolve: {
            extensions: useTypescript ? [".ts", ".tsx", ".js", ".jsx"] : [".js", ".jsx"],
        },
        module: {
            rules: useTypescript ? [
                { test: /\.(js|jsx|tsx|ts)$/, loader: "ts-loader", exclude: /node_modules/ },
                { test: /\.(jpg|png|jpeg|svg)/, type: 'asset/resource', exclude: /node_modules/ }
            ] : [
                { test: /\.(js|jsx)$/, loader: 'babel-loader', exclude: /node_modules/, options: { presets: ['@babel/preset-react'] } },
                { test: /\.(jpg|png|jpeg|svg)/, type: 'asset/resource', exclude: /node_modules/ }
            ],
