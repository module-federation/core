...
export function formatShare(
  ...
  return {
    ...
    ...shareArgs,
    shareConfig: {
      requiredVersion: shareArgs.requiredVersion ?? `^${shareArgs.version}`,
      singleton: shareArgs.singleton ?? false,
      eager: shareArgs.eager ?? false,
      strictVersion: shareArgs.strictVersion ?? false,
