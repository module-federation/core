...
describe('index', () => {
  ...
  describe('NativeFederationTypeScriptRemote', () => {
    ...
    it(
      'correctly enrich webpack config',
      async () => {
        ...
        expect(
          Boolean(
            assets.find((asset) => asset.name === '@mf-tests-webpack.zip'),
          ),
        ).toEqual(true);
    ...
    it(
      'correctly enrich rspack config',
      async () => {
        const options = {
          moduleFederationConfig: {
            name: 'moduleFederationTypescript',
        ...
        expect(
          Boolean(
            assets.find((asset) => asset.name === '@mf-tests-rspack.zip'),
          ),
        ).toEqual(true);
