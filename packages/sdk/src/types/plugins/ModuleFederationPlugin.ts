...
export interface SharedConfig {
  ...
  /**
   * Options for excluding specific versions or request paths of the shared module.
   */
  exclude?: IncludeExcludeOptions;
  /**
   * Options for including only specific versions or request paths of the shared module.
   */
  include?: IncludeExcludeOptions;
  /**
   * Layer in which the shared module should be placed.
  ...
  allowNodeModulesSuffixMatch?: boolean;
  /**
   * Custom file name for independent share build/output.
   */
