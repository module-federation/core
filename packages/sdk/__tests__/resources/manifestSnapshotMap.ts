...
const manifest: { [key: string]: Stats } = {
    ...
    "exposes": [
      {
        ...
        "assets": {
          ...
          "css": {
            "sync": [
              "__federation_expose_defautl_export.css"
            ],
            "async": []
          }
        }
      },
      {
        ...
        "assets": {
          ...
          "css": {
            "sync": [
              "__FEDERATION_expose_button.css"
            ],
            "async": []
          }
        }
      },
      {
        ...
        "assets": {
          "js": {
            "sync": [
              "__FEDERATION_expose_dynamic_variable.js"
            ],
            "async": []
          },
          "css": {
      ...
      },
      {
        ...
        "assets": {
          "js": {
            "sync": [
              "__FEDERATION_expose_buildVersion.js"
            ],
            "async": []
          },
          "css": {
      ...
      },
      {
        ...
        "assets": {
          "js": {
            "sync": [
              "__FEDERATION_expose_counter.js"
            ],
            "async": []
          },
          "css": {
  ...
  prodAppManifestWithGetPublicPath: {
    ...
    "metaData": {
      ...
      "getPublicPath": "return 'https://xxx.com/__FEDERATION_micro-app-sub3/1.0.0.1513/'"
    },
    "shared": [],
    "remotes": [],
    "exposes": [
      {
        ...
        "assets": {
          "js": {
            "sync": [
              "__FEDERATION_expose_react.233fdc6d66f893bf299e.js"
            ],
            "async": []
          },
          "css": {
    ...
    "exposes": [
      {
        ...
        "assets": {
          "js": {
            ...
            "async": [
              "src_testK_ts.5fe32394d3703d02c2ac.js"
            ]
          },
          "css": {
            "sync": [],
