...
function transformInlineServerActions(content, filename, inlineActions) {
  ...
  for (const action of sorted) {
    ...
    const registration =
      '\n;(function(){if(typeof ' +
      action.name +
      "==='function'){require('@module-federation/react-server-dom-webpack/server').registerServerReference(" +
      action.name +
      ",'" +
      moduleUrl +
      "','" +
...
module.exports = function () {
  const Server = require('@module-federation/react-server-dom-webpack/server'),
