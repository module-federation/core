...
export const getFederationEntryFromCache = (
  remoteName: string,
): string | null => {
...
export const resolveUrl = (
  ...
  try {
    ...
    const entryUrl =
      getFederationEntryFromCache(remoteName) ||
      getFederationEntryFromGlobalInstances(remoteName);
 ...
 */
export const initializeFederationChunkLoading = (
  args: any,
): { installedChunks: { [key: string]: any } } => {
