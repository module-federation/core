...
export const getFederationEntryFromCache = (remoteName: string): string | null => {
...
export const getFederationEntryFromGlobalInstances = (
  remoteName: string,
): string | null => {
  const globalThisVal = new Function('return globalThis')();
  const federationInstances = globalThisVal['__FEDERATION__']['__INSTANCES__'];
...
export const resolveUrl = (
  ...
  try {
    ...
    const entryUrl =
      getFederationEntryFromCache(remoteName) || getFederationEntryFromGlobalInstances(remoteName);
 ...
 */
export const configureFederationScriptLoader = (): void => {
 ...
 */
export const createFederationChunkHandler = (
  installedChunks: { [key: string]: any },
  args: any,
 ...
 */
export const patchWebpackRequireForFederation = (
 ...
 */
export const initializeFederationChunkLoading = (args: any): { installedChunks: { [key: string]: any } } => {
  ...
  patchWebpackRequireForFederation(handle);
