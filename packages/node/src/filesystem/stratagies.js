...
export async function fileSystemRunInContextStrategy(chunkId,rootOutputDir, remotes, callback) {
    var fs = require("fs");
    var path = require("path");
    var vm = require("vm");
    var filename = require('path').join(__dirname, rootOutputDir + __webpack_require__.u(chunkId));
...
// HttpEvalStrategy
export async function httpEvalStrategy(chunkName,remoteName, remotes, callback) {
