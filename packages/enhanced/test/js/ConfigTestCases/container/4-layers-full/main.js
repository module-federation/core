(() => {
      ...
      /***/ (
        ...
        it('should load the component from container', () => {
          return Promise.all(
            ...
            .then(
              __webpack_require__.bind(__webpack_require__, /*! ./App */ 502),
            )
            .then(({ default: App }) => {
              const rendered = App();
  ...
  \************************************************/
      /***/ (module) => {
        'use strict';
        module.exports = require('../3-layers-full/container.js');
...
${handleError(rest.join('\n'))}`;
  ...
  var __webpack_exports__ = (__webpack_exec__(815), __webpack_exec__(237));
})();
