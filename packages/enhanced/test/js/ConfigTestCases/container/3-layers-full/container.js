/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ '../../../../node_modules/.federation/entry.9960ea71cc728b3fcd9c7be15914152a.js':
      /*!**************************************************************************************!*\
  !*** ../../../../node_modules/.federation/entry.9960ea71cc728b3fcd9c7be15914152a.js ***!
  \**************************************************************************************/
      /***/ (
        ...
        /* harmony import */ var _Users_bytedance_dev_universe_packages_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../../../../webpack-bundler-runtime/dist/index.cjs.js */ '../../../../../webpack-bundler-runtime/dist/index.cjs.js',
          );
  ...
  \************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        var polyfills = __webpack_require__(
          /*! ./polyfills.cjs.js */ '../../../../../runtime/dist/polyfills.cjs.js',
        );
        var sdk = __webpack_require__(
          /*! @module-federation/sdk */ '../../../../../sdk/dist/index.cjs.js',
        );
        var share = __webpack_require__(
          /*! ./share.cjs.js */ '../../../../../runtime/dist/share.cjs.js',
        );
        var errorCodes = __webpack_require__(
          /*! @module-federation/error-codes */ '../../../../../error-codes/dist/index.cjs.js',
        );
        ...
        class PluginSystem {
          ...
          removePlugin(pluginName) {
            ...
            share.assert(
              plugin,
              `The plugin "${pluginName}" is not registered.`,
            );
            ...
            if (globalRemoteSnapshot) {
              if (sdk.isManifestProvider(globalRemoteSnapshot)) {
                ...
                const globalSnapshotRes =
                  share.setGlobalSnapshotInfoByModuleInfo(
        ...
        class SharedHandler {
          ...
          initializeSharing(
            shareScopeName = share.DEFAULT_SCOPE,
            extraOptions,
          ) {
            const { host } = this;
  ...
  \************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function getBuilderId() {
          //@ts-ignore
          return true ? 'layer_container:0.8.3' : 0;
        }
            ...
            if (
              ...
              const defaultResolver = () => {
                const resolveWithLayers = (version) => {
                  ...
                  if (
                    !shareInfo.layer &&
                    ((_versionInfo_shareConfig = versionInfo.shareConfig) ==
                    null
                      ? void 0
  ...
  \********************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        var isomorphicRslog = __webpack_require__(
          /*! isomorphic-rslog */ '../../../../../../node_modules/.pnpm/isomorphic-rslog@0.0.6/node_modules/isomorphic-rslog/dist/node/index.cjs',
        );
        var polyfills = __webpack_require__(
          /*! ./polyfills.cjs.js */ '../../../../../sdk/dist/polyfills.cjs.js',
        );
  ...
  \****************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        var runtime = __webpack_require__(
          /*! @module-federation/runtime */ '../../../../../runtime/dist/index.cjs.js',
        );
        var constant = __webpack_require__(
          /*! ./constant.cjs.js */ '../../../../../webpack-bundler-runtime/dist/constant.cjs.js',
        );
        var sdk = __webpack_require__(
          /*! @module-federation/sdk */ '../../../../../sdk/dist/index.cjs.js',
        );
        var polyfills = __webpack_require__(
          /*! ./polyfills.cjs.js */ '../../../../../webpack-bundler-runtime/dist/polyfills.cjs.js',
        );
              ...
              try {
                ...
                console.log('Loading share:', {
                  ...
                  issuerLayer:
                    shareInfo == null
                      ? void 0
                      : (_shareInfo_shareConfig1 = shareInfo.shareConfig) ==
                          null
                        ? void 0
  ...
  \********************************************************************/
    ...
    /***/ 'webpack/container/entry/layer_container':
      /*!***********************!*\
  !*** container entry ***!
  \***********************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        var moduleMap = {
          './ComponentA': () => {
            return Promise.all(
              /*! __federation_expose_ComponentA */ [
                __webpack_require__.e(
                  'webpack_sharing_consume_default_react_react',
                ),
                __webpack_require__.e('__federation_expose_ComponentA'),
              ],
            ).then(
              () => () =>
                __webpack_require__(/*! ./ComponentA */ './ComponentA.js'),
            );
          },
          './ComponentALayers': () => {
            return __webpack_require__
              .e(
                /*! __federation_expose_ComponentALayers */ '__federation_expose_ComponentALayers',
              )
              .then(
                () => () =>
                  __webpack_require__(
                    /*! ./ComponentALayers */ '(layered-components)/./ComponentALayers.js',
                  ),
              );
          },
        };
        ...
        __webpack_require__(
          /*! ../../../../node_modules/.federation/entry.9960ea71cc728b3fcd9c7be15914152a.js */ '../../../../node_modules/.federation/entry.9960ea71cc728b3fcd9c7be15914152a.js',
        );
...
${handleError(rest.join('\n'))}`;
        ...
        function finalLog(label, text, args, message) {
          ...
          if (text && Array.isArray(message) && !(message instanceof Error)) {
            ...
            console.log(
              labelStr.length ? `${labelStr} ${text}` : text,
              ...args,
            );
          }
        }
        ...
        /******/ case 'default':
          {
            /******/ register('react', '0', () =>
              __webpack_require__
                .e('_layered-components_node_modules_react_js')
                .then(
                  () => () =>
                    __webpack_require__(
                      /*! ./node_modules/react.js */ '(layered-components)/./node_modules/react.js',
                    ),
                ),
            );
            /******/ register('react', '0', () =>
              __webpack_require__
                .e('node_modules_react_js')
                .then(
                  () => () =>
                    __webpack_require__(
  ...
  /******/ (() => {
    ...
    /******/ var moduleToHandlerMapping = {
      /******/ 'webpack/sharing/consume/default/react/react': {
        /******/ getter: () =>
          __webpack_require__
            ...
            .then(
              () => () =>
                __webpack_require__(/*! react */ './node_modules/react.js'),
            ),
        /******/ shareInfo: {
          /******/ shareConfig: {
      ...
      /******/ '(layered-components)/webpack/sharing/consume/default/react/react':
        {
          /******/ getter: () =>
            __webpack_require__
              .e('_layered-components_node_modules_react_js')
              .then(
                () => () =>
                  __webpack_require__(
                    /*! react */ '(layered-components)/./node_modules/react.js',
                  ),
              ),
          /******/ shareInfo: {
            /******/ shareConfig: {
    ...
    /******/ var chunkMapping = {
      ...
      /******/ __federation_expose_ComponentALayers: [
        /******/ '(layered-components)/webpack/sharing/consume/default/react/react',
        /******/
      ],
      /******/
    ...
    /******/ __webpack_require__.f.readFileVm = function (chunkId, promises) {
      ...
      /******/ if (installedChunkData !== 0) {
        ...
        /******/ if (installedChunkData) {
          ...
          /******/ if (
            'webpack_sharing_consume_default_react_react' != chunkId
          ) {
