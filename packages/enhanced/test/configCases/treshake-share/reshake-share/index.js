...
const treeshakeSharedDir = path.join(__dirname, 'independent-packages');
...
it('correct handle share dep while reshake', async () => {
  ...
  ).reshake_share_ui_lib_100;
  await uiLibShareContainerModule.init(
    {},
    {
      installInitialConsumes: async ({ webpackRequire }) => {
        webpackRequire.m['webpack/sharing/consume/default/ui-lib-dep'] = (
          m,
        ) => {
          m.exports = {
            Message: 'Message',
