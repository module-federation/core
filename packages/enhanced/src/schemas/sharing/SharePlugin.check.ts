                    ...
                    if (u) {
                      ...
                      if (u) {
                        ...
                        if (u) {
                          ...
                          if (u) {
                            if (void 0 !== n.treeshake) {
                              const r = f;
                              if ('boolean' != typeof n.treeshake)
                                return (
                                  (s.errors = [
                                    { params: { type: 'boolean' } },
                                  ]),
                            ...
                            if (u) {
                              ...
                              if (u) {
                                if (void 0 !== n.independentShareFileName) {
                                  let r = n.independentShareFileName;
                                  const e = f;
                                  if (f === e) {
                                    if ('string' != typeof r)
                                      return (
