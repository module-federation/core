...
export default {
  "definitions": {
    ...
    "ExposesConfig": {
      ...
      "properties": {
        ...
        "layer": {
          "description": "Layer in which the exposed module should be placed.",
          "type": "string",
          "minLength": 1
        }
      },
  ...
  "properties": {
    ...
    "treeShakingSharedExcludePlugins": {
      "description": "Plugin names to exclude from independent shared compilation (will be filtered out by name).",
      "type": "array",
      "items": {
        "type": "string",
        "minLength": 1
    ...
    "treeShakingSharedPlugins": {
      "description": "List of plugin module paths to apply when building independent shared fallbacks.",
      "type": "array",
      "items": {
        "type": "string",
        "minLength": 1
    ...
    "shareStrategy": {
      "description": "Strategy for resolving shared modules (defaults to 'version-first').",
      "enum": [
        "version-first",
        "loaded-first"
      ],
    ...
    "experiments": {
      ...
      "properties": {
        ...
        "externalRuntime": {
          "description": "Externalize '@module-federation/runtime-core' and expect global '_FEDERATION_RUNTIME_CORE' at runtime.",
          "type": "boolean"
        },
        "provideExternalRuntime": {
          "description": "Provide external runtime injection for pure consumer builds (no `exposes`). When enabled, automatically adds '@module-federation/inject-external-runtime-core-plugin'. Throws error if used together with exposes.",
          "type": "boolean"
        },
        "optimization": {
    ...
    "getPublicPath": {
      "description": "Stringified function or return expression to compute dynamic publicPath. Effective only when 'exposes' is set. Example: `function(){ return window.cdn_prefix }` or `return 'https://cdn.example.com/app/'`.",
      "type": "string"
    },
    "dataPrefetch": {
