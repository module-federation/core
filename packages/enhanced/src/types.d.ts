...
type LoaderDefinition<
  OptionsType = Record<unknown, unknown>,
  ContextAdditions = Record<unknown, unknown>,
...
declare interface LoaderModule<
  OptionsType = Record<unknown, unknown>,
  ContextAdditions = Record<unknown, unknown>,
> {
  default?:
...
declare abstract class StatsPrinter {
  hooks: Readonly<{
    ...
    print: HookMap<
      SyncBailHook<[Record<unknown, unknown>, StatsPrinterContext], string>
    >;
