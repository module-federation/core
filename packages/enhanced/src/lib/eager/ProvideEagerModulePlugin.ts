...
import ProvideEagerModuleFactory from './ProvideEagerModuleFactory';
import type {
...
class ProvideEagerModulePlugin {
    ...
    compiler.hooks.compilation.tap(
      ...
      (compilation: Compilation, { normalModuleFactory }) => {
        ...
        compilation.dependencyFactories.set(
          ...
          // @ts-ignore
          new ProvideEagerModuleFactory(),
        );
      },
    );
  }
}
export default ProvideEagerModulePlugin;
