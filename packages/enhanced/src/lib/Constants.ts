 ...
 */
export const JAVASCRIPT_MODULE_TYPE_AUTO: Readonly<"javascript/auto"> = 'javascript/auto';

/**
 * @type {Readonly<"javascript/dynamic">}
 */
export const JAVASCRIPT_MODULE_TYPE_DYNAMIC: Readonly<"javascript/dynamic"> = 'javascript/dynamic';
 ...
 */
export const JAVASCRIPT_MODULE_TYPE_ESM: Readonly<"javascript/esm"> = 'javascript/esm';
 ...
 *
 */
export const WEBASSEMBLY_MODULE_TYPE_ASYNC: Readonly<"webassembly/async"> = 'webassembly/async';
 ...
 */
export const WEBASSEMBLY_MODULE_TYPE_SYNC: Readonly<"webassembly/sync"> = 'webassembly/sync';
 ...
 */
export const ASSET_MODULE_TYPE_INLINE: Readonly<"asset/inline"> = 'asset/inline';
 ...
 */
export const ASSET_MODULE_TYPE_RESOURCE: Readonly<"asset/resource"> = 'asset/resource';
 ...
 */
export const ASSET_MODULE_TYPE_SOURCE: Readonly<"asset/source"> = 'asset/source';

/**
 * @type {Readonly<"asset/raw-data-url">}
 * TODO: Document what this asset type is for. See css-loader tests for its usage.
 */
export const ASSET_MODULE_TYPE_RAW_DATA_URL: Readonly<"asset/raw-data-url"> = 'asset/raw-data-url';
 ...
 */
export const WEBPACK_MODULE_TYPE_FALLBACK: Readonly<"fallback-module"> = 'fallback-module';
 ...
 * TODO: Document this better.
 */
export const WEBPACK_MODULE_TYPE_REMOTE: Readonly<"remote-module"> = 'remote-module';
 ...
 * TODO: Document this better.
 */
export const WEBPACK_MODULE_TYPE_PROVIDE: Readonly<"provide-module"> = 'provide-module';
 ...
 */
export const WEBPACK_MODULE_TYPE_CONSUME_SHARED_MODULE: Readonly<"consume-shared-module"> = 'consume-shared-module';
 ...
 */
export const WEBPACK_MODULE_TYPE_LAZY_COMPILATION_PROXY: Readonly<"lazy-compilation-proxy"> = 'lazy-compilation-proxy';
