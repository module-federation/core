...
class TreeshakeConsumeSharedModule extends Module {
  ...
  override build(
    ...
    if (this.options.import) {
      const dep = new TreeshakeConsumeSharedFallbackDependency(
        this.options.import,
        this.options.layer,
      );
...
makeSerializable(
  TreeshakeConsumeSharedModule,
  'enhanced/lib/sharing/TreeshakeConsumeSharedModule',
);

export default TreeshakeConsumeSharedModule;
