...
import TreeshakeConsumeSharedFallbackDependency from './TreeshakeConsumeSharedFallbackDependency';
import TreeshakeConsumeSharedModule from './TreeshakeConsumeSharedModule';
import TreeshakeConsumeSharedRuntimeModule from './TreeshakeConsumeSharedRuntimeModule';
...
class TreeshakeConsumeSharedPlugin {
  ...
  createConsumeSharedModule(
  ...
  ): Promise<TreeshakeConsumeSharedModule> {
    ...
    return Promise.all([
      ...
      const consumedModule = new TreeshakeConsumeSharedModule(
        directFallback ? compilation.compiler.context : context,
        currentConfig,
      );
            ...
            (err, result) => {
              ...
              if (
                ...
                return resolveFilter(
                  undefined as unknown as TreeshakeConsumeSharedModule,
                );
              }
      ...
      if (config.exclude && typeof config.exclude.version === 'string') {
        ...
        if (
          ...
          if (
            ...
            return undefined as unknown as TreeshakeConsumeSharedModule;
          }
          return consumedModule;
        }
    ...
    compiler.hooks.thisCompilation.tap(
      ...
      (compilation: Compilation, { normalModuleFactory }) => {
        compilation.dependencyFactories.set(
          TreeshakeConsumeSharedFallbackDependency,
          normalModuleFactory,
        );
        ...
        compilation.hooks.additionalTreeRuntimeRequirements.tap(
          ...
          (chunk, set) => {
            ...
            compilation.addRuntimeModule(
              chunk,
              new TreeshakeConsumeSharedRuntimeModule(set),
            );
...
export default TreeshakeConsumeSharedPlugin;
