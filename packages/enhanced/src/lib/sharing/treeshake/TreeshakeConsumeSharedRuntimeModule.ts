...
class TreeshakeConsumeSharedRuntimeModule extends RuntimeModule {
  ...
  override generate(): string | null {
    ...
    const addModules = (
      ...
      for (const m of modules) {
        const module: TreeshakeConsumeSharedModule =
          m as unknown as TreeshakeConsumeSharedModule;
        // @ts-ignore
...
export default TreeshakeConsumeSharedRuntimeModule;
